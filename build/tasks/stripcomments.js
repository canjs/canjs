...
module.exports = function (grunt) {
	grunt.registerMultiTask('stripcomments', 'Remove multiline comments from files', function () {
		var options = grunt.config.process(['stripcomments', this.target]);
		grunt.file.expandFiles(options.files).forEach(function (file) {
