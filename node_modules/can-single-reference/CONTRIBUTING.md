# Contributing to can-single-reference

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-single-reference) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-single-reference, you can start by going to its [fork page](https://github.com/canjs/can-single-reference/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-single-reference
```
