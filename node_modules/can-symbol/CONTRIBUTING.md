# Contributing to can-symbol

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-symbol) on your computer.
...
```shell
git clone https://github.com/YOUR-USERNAME/can-symbol
```
