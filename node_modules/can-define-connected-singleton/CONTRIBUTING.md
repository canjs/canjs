# Contributing to can-define-connected-singleton

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/Bitovi/can-define-connected-singleton) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-define-connected-singleton, you can start by going to its [fork page](https://github.com/Bitovi/can-define-connected-singleton/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-define-connected-singleton
```
...
```shell
cd can-define-connected-singleton
```
