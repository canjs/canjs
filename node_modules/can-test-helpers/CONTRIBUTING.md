# Contributing to can-test-helpers
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-test-helpers) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-test-helpers, you can start by going to its [fork page](https://github.com/canjs/can-test-helpers/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-test-helpers
```
