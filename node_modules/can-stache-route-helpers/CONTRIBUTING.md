# Contributing to can-stache-route-helpers

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/donejs/can-stache-route-helpers) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-stache-route-helpers, you can start by going to its [fork page](https://github.com/donejs/can-stache-route-helpers/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-stache-route-helpers
```
