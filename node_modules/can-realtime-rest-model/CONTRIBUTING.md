# Contributing to can-realtime-rest-model

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-realtime-rest-model) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-realtime-rest-model, you can start by going to its [fork page](https://github.com/canjs/can-realtime-rest-model/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-realtime-rest-model
```
