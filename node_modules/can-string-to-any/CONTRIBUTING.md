# Contributing to can-string-to-any

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-string-to-any) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-string-to-any, you can start by going to its [fork page](https://github.com/canjs/can-string-to-any/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-string-to-any
```
