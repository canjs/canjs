# Contributing to can-importer

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//can-importer) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-importer, you can start by going to its [fork page](https://github.com//can-importer/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-importer
```
