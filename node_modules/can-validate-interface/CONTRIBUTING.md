# Contributing to can-validate-interface
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-validate-interface) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-validate-interface, you can start by going to its [fork page](https://github.com/canjs/can-validate-interface/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-validate-interface
```
