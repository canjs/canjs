# Contributing to can-view-scope
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-view-scope) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-view-scope, you can start by going to its [fork page](https://github.com/canjs/can-view-scope/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-view-scope
```
