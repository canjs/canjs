# Contributing to can-stream-kefir
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-stream-kefir) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-stream-kefir, you can start by going to its [fork page](https://github.com/canjs/can-stream-kefir/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-stream-kefir
```
