# Contributing to can-define-stream-kefir
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-define-stream-kefir) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-define-stream-kefir, you can start by going to its [fork page](https://github.com/canjs/can-define-stream-kefir/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-define-stream-kefir
```
