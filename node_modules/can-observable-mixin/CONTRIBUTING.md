# Contributing to can-observable-mixin
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-observable-mixin) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-observable-mixin, you can start by going to its [fork page](https://github.com/canjs/can-observable-mixin/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-observable-mixin
```
