# Contributing to can-map-compat

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//can-map-compat) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-map-compat, you can start by going to its [fork page](https://github.com//can-map-compat/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-map-compat
```
