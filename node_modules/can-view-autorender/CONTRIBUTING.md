# Contributing to can-view-autorender
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-view-autorender) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-view-autorender, you can start by going to its [fork page](https://github.com/canjs/can-view-autorender/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-view-autorender
```
