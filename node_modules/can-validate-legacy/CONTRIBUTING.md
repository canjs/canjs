# Contributing to can-validate-legacy
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-validate-legacy) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-validate-legacy, you can start by going to its [fork page](https://github.com/canjs/can-validate-legacy/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-validate-legacy
```
