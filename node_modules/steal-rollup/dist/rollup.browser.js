/*
	Rollup.js v0.58.4
	Wed, 28 Nov 2018 20:19:51 GMT - commit efdc147ba50bfec70418f046cf6837d7dcce8c3d
...
(function (global, factory) {
    ...
    var ReassignedPathTracker = /** @class */ (function () {
        ...
        ReassignedPathTracker.prototype.reassignSubPath = function (path) {
        ...
        ReassignedPathTracker.prototype.onSubPathIfReassigned = function (path, callback) {
            var subPath = path[0], remainingPath = path.slice(1);
    ...
    var VariableReassignmentTracker = /** @class */ (function () {
        ...
        VariableReassignmentTracker.prototype.someAtPath = function (path, predicateFunction) {
            return (this.reassignedPathTracker.someReassignedPath(path, predicateFunction) ||
    ...
    var ObjectExpression = /** @class */ (function (_super) {
        ...
        ObjectExpression.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
            if (path.length === 0)
                return;
            var _a = this.getPossiblePropertiesWithName(path[0], PROPERTY_KINDS_READ), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
            if (hasCertainHit) {
        ...
        ObjectExpression.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
            if (path.length === 0)
                return false;
            var _a = this.getPossiblePropertiesWithName(path[0], path.length === 1 ? PROPERTY_KINDS_WRITE : PROPERTY_KINDS_READ), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
            if (path.length > 1 && !hasCertainHit)
                return true;
    ...
    var Chunk$1 = /** @class */ (function () {
        ...
        Chunk.prototype.preRender = function (options) {
            ...
            for (var _f = 0, _g = this.dependencies; _f < _g.length; _f++) {
                var external = _g[_f];
