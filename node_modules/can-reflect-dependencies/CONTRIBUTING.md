# Contributing to can-reflect-dependencies
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-reflect-dependencies) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-reflect-dependencies, you can start by going to its [fork page](https://github.com/canjs/can-reflect-dependencies/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-reflect-dependencies
```
