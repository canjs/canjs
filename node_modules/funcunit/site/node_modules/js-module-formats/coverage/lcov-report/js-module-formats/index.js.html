...
<html lang="en">
<head>
    <title>Code coverage report for js-module-formats/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">js-module-formats/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">js-module-formats/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    return mods.length &gt; 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >mods </span>: mods[0];
}
&nbsp;
/**
...
function detect(src) {
    var mod = extract(src);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(mod)) {
<span class="cstat-no" title="statement not covered" >        mod = mod.shift(); </span>// picking up the first module from the list
    }
    return mod &amp;&amp; mod.type;
}
&nbsp;</pre></td></tr>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Apr 21 2014 12:21:09 GMT-0400 (EDT)</div>
</div>
