# Contributing to can-view-parser
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-view-parser) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-view-parser, you can start by going to its [fork page](https://github.com/canjs/can-view-parser/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-view-parser
```
