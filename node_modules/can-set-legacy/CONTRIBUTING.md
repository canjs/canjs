# Contributing to can-set-legacy

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-set-legacy) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-set-legacy, you can start by going to its [fork page](https://github.com/canjs/can-set-legacy/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-set-legacy
```
