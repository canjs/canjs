# Contributing to can-event-dom-enter

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-event-dom-enter) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-event-dom-enter, you can start by going to its [fork page](https://github.com/canjs/can-event-dom-enter/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-event-dom-enter
```
