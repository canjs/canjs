# Contributing to can-type

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/DoneJS/can-type) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-type, you can start by going to its [fork page](https://github.com/DoneJS/can-type/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-type
```
