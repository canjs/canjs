# Contributing to steal-config-utils

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//steal-config-utils) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork steal-config-utils, you can start by going to its [fork page](https://github.com//steal-config-utils/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/steal-config-utils
```
