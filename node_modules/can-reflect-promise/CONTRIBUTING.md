# Contributing to can-reflect-promise
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-reflect-promise) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-reflect-promise, you can start by going to its [fork page](https://github.com/canjs/can-reflect-promise/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-reflect-promise
```
