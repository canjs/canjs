# Contributing to can-route-hash

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//can-route-hash) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-route-hash, you can start by going to its [fork page](https://github.com//can-route-hash/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-route-hash
```
