# Contributing to can-view-callbacks
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-view-callbacks) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-view-callbacks, you can start by going to its [fork page](https://github.com/canjs/can-view-callbacks/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-view-callbacks
```
