...
This section will walk you through setting up the [repository](https://github.com/canjs/steal-stache) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork steal-stache, you can start by going to its [fork page](https://github.com/canjs/steal-stache/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/steal-stache
```
