# Contributing to can-make-map

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-make-map) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-make-map, you can start by going to its [fork page](https://github.com/canjs/can-make-map/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-make-map
```
