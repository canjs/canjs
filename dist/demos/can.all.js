...
define('can-util@3.11.2#namespace', [
    'require',
    'exports',
    'module',
    'can-namespace@1.0.0#can-namespace'
], function (require, exports, module) {
    module.exports = require('can-namespace@1.0.0#can-namespace');
});
...
define('can-util@3.11.2#js/assign/assign', [
    ...
    'use strict';
    module.exports = require('can-assign@1.1.1#can-assign');
});
...
define('can-util@3.11.2#js/deep-assign/deep-assign', [
    ...
    'use strict';
    var isFunction = require('can-util@3.11.2#js/is-function/is-function');
    var isPlainObject = require('can-util@3.11.2#js/is-plain-object/is-plain-object');
    function deepAssign() {
...
define('can-log@1.0.0#dev/dev', [
    ...
    'use strict';
    var canLog = require('can-log@1.0.0#can-log');
    module.exports = {
        warnTimeout: 5000,
        logLevel: 0,
...
define('can-util@3.11.2#js/dev/dev', [
    ...
    'use strict';
    module.exports = require('can-log@1.0.0#dev/dev');
});
...
define('can-util@3.11.2#js/is-iterable/is-iterable', [
    ...
    'use strict';
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
...
define('can-util@3.11.2#js/each/each', [
    ...
    'use strict';
    var isArrayLike = require('can-util@3.11.2#js/is-array-like/is-array-like');
    var has = Object.prototype.hasOwnProperty;
    var isIterable = require('can-util@3.11.2#js/is-iterable/is-iterable');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
...
define('can-util@3.11.2#js/make-array/make-array', [
    ...
    'use strict';
    var each = require('can-util@3.11.2#js/each/each');
    var isArrayLike = require('can-util@3.11.2#js/is-array-like/is-array-like');
...
define('can-util@3.11.2#js/get/get', [
    ...
    'use strict';
    var isContainer = require('can-util@3.11.2#js/is-container/is-container');
...
define('can-util@3.11.2#js/is-array/is-array', [
    ...
    'use strict';
    var dev = require('can-log@1.0.0#dev/dev');
    var hasWarned = false;
...
define('can-util@3.11.2#js/string/string', [
    ...
    'use strict';
    var get = require('can-util@3.11.2#js/get/get');
    var isContainer = require('can-util@3.11.2#js/is-container/is-container');
    var canDev = require('can-log@1.0.0#dev/dev');
    var isArray = require('can-util@3.11.2#js/is-array/is-array');
...
define('can-construct@3.3.0#can-construct', [
    ...
    'use strict';
    var assign = require('can-util@3.11.2#js/assign/assign');
    var deepAssign = require('can-util@3.11.2#js/deep-assign/deep-assign');
    var dev = require('can-util@3.11.2#js/dev/dev');
    var makeArray = require('can-util@3.11.2#js/make-array/make-array');
    var namespace = require('can-namespace@1.0.0#can-namespace');
    var CanString = require('can-util@3.11.2#js/string/string');
    var reservedWords = {
        'abstract': true,
        'boolean': true,
        'break': true,
...
define('can-reflect@1.13.2#reflections/type/type', [
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var helpers = require('can-reflect@1.13.2#reflections/helpers');
...
define('can-reflect@1.13.2#reflections/call/call', [
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var typeReflections = require('can-reflect@1.13.2#reflections/type/type');
    module.exports = {
...
define('can-reflect@1.13.2#reflections/shape/shape', [
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var getSetReflections = require('can-reflect@1.13.2#reflections/get-set/get-set');
    var typeReflections = require('can-reflect@1.13.2#reflections/type/type');
    var helpers = require('can-reflect@1.13.2#reflections/helpers');
    var ArrayMap;
...
define('can-reflect@1.13.2#types/map', [
    ...
    var shape = require('can-reflect@1.13.2#reflections/shape/shape');
    var CanSymbol = require('can-symbol@1.6.0#can-symbol');
...
define('can-reflect@1.13.2#can-reflect', [
    ...
    var functionReflections = require('can-reflect@1.13.2#reflections/call/call');
    var getSet = require('can-reflect@1.13.2#reflections/get-set/get-set');
    var observe = require('can-reflect@1.13.2#reflections/observe/observe');
    var shape = require('can-reflect@1.13.2#reflections/shape/shape');
    var type = require('can-reflect@1.13.2#reflections/type/type');
    var getName = require('can-reflect@1.13.2#reflections/get-name/get-name');
    var namespace = require('can-namespace@1.0.0#can-namespace');
    var reflect = {};
    [
        functionReflections,
    ...
    require('can-reflect@1.13.2#types/map');
    require('can-reflect@1.13.2#types/set');
...
define('can-queues@1.0.0#queue', [
    ...
    var queueState = require('can-queues@1.0.0#queue-state');
    var canDev = require('can-log@1.0.0#dev/dev');
    var assign = require('can-assign@1.1.1#can-assign');
...
define('can-queues@1.0.0#priority-queue', [
    ...
    var Queue = require('can-queues@1.0.0#queue');
...
define('can-queues@1.0.0#can-queues', [
    ...
    var canDev = require('can-util@3.11.2#js/dev/dev');
    var Queue = require('can-queues@1.0.0#queue');
    var PriorityQueue = require('can-queues@1.0.0#priority-queue');
    var queueState = require('can-queues@1.0.0#queue-state');
    var CompletionQueue = require('can-queues@1.0.0#completion-queue');
    var ns = require('can-namespace@1.0.0#can-namespace');
...
define('can-key-tree@1.0.0#can-key-tree', [
    ...
    var reflect = require('can-reflect@1.13.2#can-reflect');
...
define('can-reflect-promise@2.0.1#can-reflect-promise', [
    ...
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var queues = require('can-queues@1.0.0#can-queues');
    var KeyTree = require('can-key-tree@1.0.0#can-key-tree');
    var dev = require('can-log@1.0.0#dev/dev');
...
define('can-stache-key@1.0.0#can-stache-key', [
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var isPromiseLike = require('can-util@3.11.2#js/is-promise-like/is-promise-like');
    var canReflectPromise = require('can-reflect-promise@2.0.1#can-reflect-promise');
...
define('can-event-queue@1.0.0#value/value', [
    ...
    var KeyTree = require('can-key-tree@1.0.0#can-key-tree');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var defineLazyValue = require('can-define-lazy-value@1.0.1#define-lazy-value');
    var mergeDependencyRecords = require('can-event-queue@1.0.0#dependency-record/merge');
    var properties = {
...
define('can-observation@4.0.0#can-observation', [
    ...
    (function (global, require, exports, module) {
        ...
        var canSymbol = require('can-symbol@1.6.0#can-symbol');
        var dev = require('can-log@1.0.0#dev/dev');
        var valueEventBindings = require('can-event-queue@1.0.0#value/value');
        var recorderHelpers = require('can-observation@4.0.0#recorder-dependency-helpers');
        var temporarilyBind = require('can-observation@4.0.0#temporarily-bind');
...
define('can-globals@1.0.0#can-globals-instance', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var Globals = require('can-globals@1.0.0#can-globals-proto');
...
define('can-globals@1.0.0#global/global', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var globals = require('can-globals@1.0.0#can-globals-instance');
...
define('can-globals@1.0.0#document/document', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        require('can-globals@1.0.0#global/global');
        var globals = require('can-globals@1.0.0#can-globals-instance');
...
define('can-globals@1.0.0#is-browser-window/is-browser-window', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var globals = require('can-globals@1.0.0#can-globals-instance');
        require('can-globals@1.0.0#is-node/is-node');
...
define('can-dom-events@1.1.1#helpers/util', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var getCurrentDocument = require('can-globals@1.0.0#document/document');
        var isBrowserWindow = require('can-globals@1.0.0#is-browser-window/is-browser-window');
...
define('can-dom-events@1.1.1#can-dom-events', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var util = require('can-dom-events@1.1.1#helpers/util');
        var makeEventRegistry = require('can-dom-events@1.1.1#helpers/make-event-registry');
        var makeDelegateEventTree = require('can-dom-events@1.1.1#helpers/-make-delegate-event-tree');
        var domEvents = {
...
define('can-event-queue@1.0.0#map/map', [
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var KeyTree = require('can-key-tree@1.0.0#can-key-tree');
    var domEvents = require('can-dom-events@1.1.1#can-dom-events');
    var isDomEventTarget = require('can-dom-events@1.1.1#helpers/util').isDomEventTarget;
    var mergeDependencyRecords = require('can-event-queue@1.0.0#dependency-record/merge');
...
define('can-globals@1.0.0#can-globals', [
    ...
    (function (global, require, exports, module) {
        ...
        var globals = require('can-globals@1.0.0#can-globals-instance');
        require('can-globals@1.0.0#global/global');
        require('can-globals@1.0.0#document/document');
        require('can-globals@1.0.0#location/location');
        require('can-globals@1.0.0#mutation-observer/mutation-observer');
        require('can-globals@1.0.0#is-browser-window/is-browser-window');
        require('can-globals@1.0.0#is-node/is-node');
        require('can-globals@1.0.0#custom-elements/custom-elements');
        module.exports = globals;
    }(function () {
        return this;
    }(), require, exports, module));
...
define('can-dom-mutate@1.0.2#-util', [
    ...
    (function (global, require, exports, module) {
        var getDocument = require('can-globals@1.0.0#document/document');
...
define('can-dom-mutate@1.0.2#can-dom-mutate', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var globals = require('can-globals@1.0.0#can-globals');
        var getRoot = require('can-globals@1.0.0#global/global');
        var getMutationObserver = require('can-globals@1.0.0#mutation-observer/mutation-observer');
        var setImmediate = getRoot().setImmediate || function (cb) {
            return setTimeout(cb, 0);
        };
        var util = require('can-dom-mutate@1.0.2#-util');
...
define('can-control@4.0.1#can-control', [
    ...
    var Construct = require('can-construct@3.3.0#can-construct');
    var namespace = require('can-namespace@1.0.0#can-namespace');
    var assign = require('can-assign@1.1.1#can-assign');
    var observeReader = require('can-stache-key@1.0.0#can-stache-key');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var Observation = require('can-observation@4.0.0#can-observation');
    var canEvent = require('can-event-queue@1.0.0#map/map');
    var dev = require('can-log@1.0.0#dev/dev');
    var string = require('can-util@3.11.2#js/string/string');
    var get = require('can-util@3.11.2#js/get/get');
    var className = require('can-util@3.11.2#dom/class-name/class-name');
    var domMutate = require('can-dom-mutate@1.0.2#can-dom-mutate');
    var processors;
...
define('can-component@4.0.1#control/control', [
    ...
    var Control = require('can-control@4.0.1#can-control');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var paramReplacer = /\{([^\}]+)\}/g;
...
define('can-view-parser@4.0.1#can-view-parser', [
    ...
    var namespace = require('can-namespace@1.0.0#can-namespace'), dev = require('can-log@1.0.0#dev/dev'), encoder = require('can-attribute-encoder@1.0.0#can-attribute-encoder');
    function each(items, callback) {
        for (var i = 0; i < items.length; i++) {
            callback(items[i], i);
        }
...
define('can-view-nodelist@4.0.1#can-view-nodelist', [
    ...
    var namespace = require('can-namespace@1.0.0#can-namespace');
    var domMutate = require('can-dom-mutate@1.0.2#node');
...
define('can-util@3.11.2#dom/fragment/fragment', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var getDocument = require('can-globals@1.0.0#document/document'), childNodes = require('can-util@3.11.2#dom/child-nodes/child-nodes');
...
define('can-util@3.11.2#dom/frag/frag', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var getDocument = require('can-globals@1.0.0#document/document');
        var fragment = require('can-util@3.11.2#dom/fragment/fragment');
        var each = require('can-util@3.11.2#js/each/each');
        var childNodes = require('can-util@3.11.2#dom/child-nodes/child-nodes');
...
define('can-view-callbacks@4.0.0#can-view-callbacks', [
    ...
    (function (global, require, exports, module) {
        var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
        var dev = require('can-log@1.0.0#dev/dev');
        var getGlobal = require('can-globals@1.0.0#global/global');
        var domMutate = require('can-dom-mutate@1.0.2#node');
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var nodeLists = require('can-view-nodelist@4.0.1#can-view-nodelist');
        var makeFrag = require('can-util@3.11.2#dom/frag/frag');
        var globals = require('can-globals@1.0.0#can-globals');
...
define('can-view-target@4.0.0#can-view-target', [
    ...
    (function (global, require, exports, module) {
        ...
        var domMutate = require('can-dom-mutate@1.0.2#node');
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var MUTATION_OBSERVER = require('can-globals@1.0.0#mutation-observer/mutation-observer');
...
define('can-simple-map@4.0.0#can-simple-map', [
    ...
    var Construct = require('can-construct@3.3.0#can-construct');
    var eventQueue = require('can-event-queue@1.0.0#map/map');
    var queues = require('can-queues@1.0.0#can-queues');
    var each = require('can-util@3.11.2#js/each/each');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
...
define('can-view-scope@4.0.1#template-context', [
    ...
    var SimpleMap = require('can-simple-map@4.0.0#can-simple-map');
...
define('can-cid@1.1.2#set/set', [
    ...
    'use strict';
    var getCID = require('can-cid@1.1.2#can-cid').get;
    var helpers = require('can-cid@1.1.2#helpers');
    var CIDSet;
    if (typeof Set !== 'undefined') {
        CIDSet = Set;
    } else {
...
define('can-util@3.11.2#js/single-reference/single-reference', [
    ...
    (function (global, require, exports, module) {
        var CID = require('can-cid@1.1.2#can-cid');
        var singleReference;
...
define('can-view-scope@4.0.1#make-compute-like', [
    ...
    var singleReference = require('can-util@3.11.2#js/single-reference/single-reference');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
...
define('can-reflect-dependencies@1.0.0#src/get-dependency-data-of', [
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var isFunction = require('can-reflect-dependencies@1.0.0#src/is-function');
...
define('can-reflect-dependencies@1.0.0#can-reflect-dependencies', [
    ...
    var addMutatedBy = require('can-reflect-dependencies@1.0.0#src/add-mutated-by');
    var deleteMutatedBy = require('can-reflect-dependencies@1.0.0#src/delete-mutated-by');
    var getDependencyDataOf = require('can-reflect-dependencies@1.0.0#src/get-dependency-data-of');
...
define('can-view-scope@4.0.1#scope-key-data', [
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var CIDSet = require('can-cid@1.1.2#set/set');
    var makeComputeLike = require('can-view-scope@4.0.1#make-compute-like');
    var canReflectDeps = require('can-reflect-dependencies@1.0.0#can-reflect-dependencies');
    var valueEventBindings = require('can-event-queue@1.0.0#value/value');
    var dispatchSymbol = canSymbol.for('can.dispatch');
...
define('can-view-scope@4.0.1#compute_data', [
    ...
    'use strict';
    var ScopeKeyData = require('can-view-scope@4.0.1#scope-key-data');
...
define('can-view-scope@4.0.1#can-view-scope', [
    ...
    (function (global, require, exports, module) {
        var observeReader = require('can-stache-key@1.0.0#can-stache-key');
        var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
        var TemplateContext = require('can-view-scope@4.0.1#template-context');
        var makeComputeData = require('can-view-scope@4.0.1#compute_data');
        var assign = require('can-assign@1.1.1#can-assign');
        var each = require('can-util@3.11.2#js/each/each');
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var canReflect = require('can-reflect@1.13.2#can-reflect');
        var canLog = require('can-log@1.0.0#dev/dev');
        var defineLazyValue = require('can-define-lazy-value@1.0.1#define-lazy-value');
        var stacheHelpers = require('can-stache-helpers@1.0.0#can-stache-helpers');
...
define('can-simple-observable@2.0.1#can-simple-observable', [
    ...
    var log = require('can-simple-observable@2.0.1#log');
    var ns = require('can-namespace@1.0.0#can-namespace');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
...
define('can-simple-observable@2.0.1#settable/settable', [
    ...
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var SimpleObservable = require('can-simple-observable@2.0.1#can-simple-observable');
    var Observation = require('can-observation@4.0.0#can-observation');
    var queues = require('can-queues@1.0.0#can-queues');
    var log = require('can-simple-observable@2.0.1#log');
    var valueEventBindings = require('can-event-queue@1.0.0#value/value');
...
define('can-stache@4.0.2#src/key-observable', [
    ...
    var SettableObservable = require('can-simple-observable@2.0.1#settable/settable');
    var stacheKey = require('can-stache-key@1.0.0#can-stache-key');
...
define('can-stache@4.0.2#src/utils', [
    ...
    var Scope = require('can-view-scope@4.0.1#can-view-scope');
    var Observation = require('can-observation@4.0.0#can-observation');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var observationReader = require('can-stache-key@1.0.0#can-stache-key');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var KeyObservable = require('can-stache@4.0.2#src/key-observable');
    var dev = require('can-log@1.0.0#dev/dev');
    var isEmptyObject = require('can-util@3.11.2#js/is-empty-object/is-empty-object');
    var isArrayLike = require('can-util@3.11.2#js/is-array-like/is-array-like');
...
define('can-view-live@4.0.1#lib/core', [
    ...
    var parser = require('can-view-parser@4.0.1#can-view-parser');
    var domMutate = require('can-dom-mutate@1.0.2#can-dom-mutate');
    var nodeLists = require('can-view-nodelist@4.0.1#can-view-nodelist');
    var makeFrag = require('can-util@3.11.2#dom/frag/frag');
    var childNodes = require('can-util@3.11.2#dom/child-nodes/child-nodes');
...
define('can-view-live@4.0.1#lib/attr', [
    ...
    var live = require('can-view-live@4.0.1#lib/core');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var domMutateNode = require('can-dom-mutate@1.0.2#node');
    var queues = require('can-queues@1.0.0#can-queues');
...
define('can-view-live@4.0.1#lib/attrs', [
    ...
    var live = require('can-view-live@4.0.1#lib/core');
    var viewCallbacks = require('can-view-callbacks@4.0.0#can-view-callbacks');
    var domMutate = require('can-dom-mutate@1.0.2#can-dom-mutate');
    var domMutateNode = require('can-dom-mutate@1.0.2#node');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var canReflectDeps = require('can-reflect-dependencies@1.0.0#can-reflect-dependencies');
...
define('can-view-live@4.0.1#lib/patcher', [
    ...
    var KeyTree = require('can-key-tree@1.0.0#can-key-tree');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var diff = require('can-util@3.11.2#js/diff/diff');
    var queues = require('can-queues@1.0.0#can-queues');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
...
define('can-view-live@4.0.1#lib/list', [
    ...
    var live = require('can-view-live@4.0.1#lib/core');
    var nodeLists = require('can-view-nodelist@4.0.1#can-view-nodelist');
    var frag = require('can-util@3.11.2#dom/frag/frag');
    var childNodes = require('can-util@3.11.2#dom/child-nodes/child-nodes');
    var domMutateNode = require('can-dom-mutate@1.0.2#node');
    var makeArray = require('can-util@3.11.2#js/make-array/make-array');
    var each = require('can-util@3.11.2#js/each/each');
    ...
    var canReflectDeps = require('can-reflect-dependencies@1.0.0#can-reflect-dependencies');
    var SimpleObservable = require('can-simple-observable@2.0.1#can-simple-observable');
    var SetObservable = require('can-view-live@4.0.1#lib/set-observable');
    var Patcher = require('can-view-live@4.0.1#lib/patcher');
    var splice = [].splice;
...
define('can-view-live@4.0.1#can-view-live', [
    ...
    var live = require('can-view-live@4.0.1#lib/core');
    require('can-view-live@4.0.1#lib/attr');
    require('can-view-live@4.0.1#lib/attrs');
    require('can-view-live@4.0.1#lib/html');
    require('can-view-live@4.0.1#lib/list');
    require('can-view-live@4.0.1#lib/text');
    module.exports = live;
});
...
define('can-stache@4.0.2#src/expression-helpers', [
    ...
    var Arg = require('can-stache@4.0.2#expressions/arg');
    var Literal = require('can-stache@4.0.2#expressions/literal');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var observeReader = require('can-stache-key@1.0.0#can-stache-key');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var Observation = require('can-observation@4.0.0#can-observation');
    var makeComputeLike = require('can-view-scope@4.0.1#make-compute-like');
    var SetterObservable = require('can-simple-observable@2.0.1#setter/setter');
...
define('can-stache@4.0.2#expressions/hashes', [
    ...
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var Observation = require('can-observation@4.0.0#can-observation');
    var expressionHelpers = require('can-stache@4.0.2#src/expression-helpers');
...
define('can-stache@4.0.2#expressions/call', [
    ...
    var Scope = require('can-view-scope@4.0.1#can-view-scope');
    var Hashes = require('can-stache@4.0.2#expressions/hashes');
    var SetIdentifier = require('can-stache@4.0.2#src/set-identifier');
    var Observation = require('can-observation@4.0.0#can-observation');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
...
define('can-util@3.11.2#js/base-url/base-url', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var getGlobal = require('can-globals@1.0.0#global/global');
        var getDomDocument = require('can-globals@1.0.0#document/document');
        var setBaseUrl;
...
define('can-util@3.11.2#js/join-uris/join-uris', [
    ...
    'use strict';
    var parseURI = require('can-parse-uri@1.0.1#can-parse-uri');
...
define('can-stache@4.0.2#helpers/core', [
    ...
    (function (global, require, exports, module) {
        var live = require('can-view-live@4.0.1#can-view-live');
        var nodeLists = require('can-view-nodelist@4.0.1#can-view-nodelist');
        var utils = require('can-stache@4.0.2#src/utils');
        var getBaseURL = require('can-util@3.11.2#js/base-url/base-url');
        var joinURIs = require('can-util@3.11.2#js/join-uris/join-uris');
        var assign = require('can-assign@1.1.1#can-assign');
        var isIterable = require('can-util@3.11.2#js/is-iterable/is-iterable');
        var dev = require('can-log@1.0.0#dev/dev');
        var canSymbol = require('can-symbol@1.6.0#can-symbol');
        ...
        var isEmptyObject = require('can-util@3.11.2#js/is-empty-object/is-empty-object');
        var Hashes = require('can-stache@4.0.2#expressions/hashes');
        var debuggerHelper = require('can-stache@4.0.2#helpers/-debugger').helper;
        var KeyObservable = require('can-stache@4.0.2#src/key-observable');
        var Observation = require('can-observation@4.0.0#can-observation');
        var TruthyObservable = require('can-stache@4.0.2#src/truthy-observable');
        var observationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
        var helpers = require('can-stache-helpers@1.0.0#can-stache-helpers');
        var domData = require('can-dom-data-state@1.0.1#can-dom-data-state');
...
define('can-stache@4.0.2#expressions/helper', [
    ...
    var expressionHelpers = require('can-stache@4.0.2#src/expression-helpers');
    var utils = require('can-stache@4.0.2#src/utils');
    var mustacheHelpers = require('can-stache@4.0.2#helpers/core');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var ScopeKeyData = require('can-view-scope@4.0.1#scope-key-data');
...
define('can-stache@4.0.2#src/expression', [
    ...
    var Literal = require('can-stache@4.0.2#expressions/literal');
    var Hashes = require('can-stache@4.0.2#expressions/hashes');
    var Bracket = require('can-stache@4.0.2#expressions/bracket');
    var Call = require('can-stache@4.0.2#expressions/call');
    var Helper = require('can-stache@4.0.2#expressions/helper');
    var Lookup = require('can-stache@4.0.2#expressions/lookup');
    var SetIdentifier = require('can-stache@4.0.2#src/set-identifier');
    var expressionHelpers = require('can-stache@4.0.2#src/expression-helpers');
    var utils = require('can-stache@4.0.2#src/utils');
    var assign = require('can-assign@1.1.1#can-assign');
    var last = require('can-util@3.11.2#js/last/last');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var sourceTextSymbol = canSymbol.for('can-stache.sourceText');
    var Hash = function () {
...
define('can-stache@4.0.2#src/mustache_core', [
    ...
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var utils = require('can-stache@4.0.2#src/utils');
    var expression = require('can-stache@4.0.2#src/expression');
    var frag = require('can-util@3.11.2#dom/frag/frag');
    var domMutate = require('can-dom-mutate@1.0.2#can-dom-mutate');
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
...
define('can-stache@4.0.2#src/html_section', [
    ...
    (function (global, require, exports, module) {
        var target = require('can-view-target@4.0.0#can-view-target');
        var Scope = require('can-view-scope@4.0.1#can-view-scope');
        var Observation = require('can-observation@4.0.0#can-observation');
        var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
        var canReflect = require('can-reflect@1.13.2#can-reflect');
        var utils = require('can-stache@4.0.2#src/utils');
        var mustacheCore = require('can-stache@4.0.2#src/mustache_core');
        var getDocument = require('can-globals@1.0.0#document/document');
        var assign = require('can-assign@1.1.1#can-assign');
        var last = require('can-util@3.11.2#js/last/last');
...
define('can-stache@4.0.2#helpers/converter', [
    ...
    var helpers = require('can-stache@4.0.2#helpers/core');
    var SetIdentifier = require('can-stache@4.0.2#src/set-identifier');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
...
define('can-util@3.11.2#js/import/import', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var isFunction = require('can-util@3.11.2#js/is-function/is-function');
        var global = require('can-globals@1.0.0#global/global')();
...
define('can-stache@4.0.2#can-stache', [
    ...
    (function (global, require, exports, module) {
        var parser = require('can-view-parser@4.0.1#can-view-parser');
        var viewCallbacks = require('can-view-callbacks@4.0.0#can-view-callbacks');
        var HTMLSectionBuilder = require('can-stache@4.0.2#src/html_section');
        var TextSectionBuilder = require('can-stache@4.0.2#src/text_section');
        var mustacheCore = require('can-stache@4.0.2#src/mustache_core');
        var mustacheHelpers = require('can-stache@4.0.2#helpers/core');
        require('can-stache@4.0.2#helpers/converter');
        var getIntermediateAndImports = require('can-stache@4.0.2#src/intermediate_and_imports');
        var makeRendererConvertScopes = require('can-stache@4.0.2#src/utils').makeRendererConvertScopes;
        var attributeEncoder = require('can-attribute-encoder@1.0.0#can-attribute-encoder');
        var dev = require('can-log@1.0.0#dev/dev');
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var DOCUMENT = require('can-globals@1.0.0#document/document');
        var assign = require('can-assign@1.1.1#can-assign');
        var last = require('can-util@3.11.2#js/last/last');
        var importer = require('can-util@3.11.2#js/import/import');
        var canReflect = require('can-reflect@1.13.2#can-reflect');
        require('can-view-target@4.0.0#can-view-target');
        require('can-view-nodelist@4.0.1#can-view-nodelist');
...
define('can-stache-bindings@4.0.5#attribute-observable/attribute-behaviors', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        var setImmediate = require('can-util@3.11.2#js/set-immediate/set-immediate');
        var getDocument = require('can-globals@1.0.0#document/document');
        var global = require('can-globals@1.0.0#global/global')();
        var isOfGlobalDocument = require('can-util@3.11.2#dom/is-of-global-document/is-of-global-document');
        var setData = require('can-dom-data-state@1.0.1#can-dom-data-state');
        var domEvents = require('can-dom-events@1.1.1#can-dom-events');
        var domMutate = require('can-dom-mutate@1.0.2#can-dom-mutate');
        var domMutateNode = require('can-dom-mutate@1.0.2#node');
        var getMutationObserver = require('can-globals@1.0.0#mutation-observer/mutation-observer');
        var each = require('can-util@3.11.2#js/each/each');
        var types = require('can-types@1.1.6#can-types');
        var diff = require('can-util@3.11.2#js/diff/diff');
        var formElements = {
                'INPUT': true,
                'TEXTAREA': true,
...
define('can-stache-bindings@4.0.5#attribute-observable/get-event-name', [
    ...
    var attr = require('can-stache-bindings@4.0.5#attribute-observable/attribute-behaviors');
...
define('can-stache-bindings@4.0.5#attribute-observable/attribute-observable', [
    ...
    (function (global, require, exports, module) {
        var queues = require('can-queues@1.0.0#can-queues');
        var canEvent = require('can-stache-bindings@4.0.5#can-event');
        var canReflect = require('can-reflect@1.13.2#can-reflect');
        var Observation = require('can-observation@4.0.0#can-observation');
        var attr = require('can-stache-bindings@4.0.5#attribute-observable/attribute-behaviors');
        var getEventName = require('can-stache-bindings@4.0.5#attribute-observable/get-event-name');
        var canReflectDeps = require('can-reflect-dependencies@1.0.0#can-reflect-dependencies');
        var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
        var SettableObservable = require('can-simple-observable@2.0.1#settable/settable');
        var domEvents = require('can-dom-events@1.1.1#can-dom-events');
        var radioChangeEvent = require('can-event-dom-radiochange@2.1.0#can-event-dom-radiochange');
...
define('can-stache-bindings@4.0.5#can-stache-bindings', [
    ...
    var expression = require('can-stache@4.0.2#src/expression');
    var viewCallbacks = require('can-view-callbacks@4.0.0#can-view-callbacks');
    var canViewModel = require('can-view-model@4.0.0#can-view-model');
    var observeReader = require('can-stache-key@1.0.0#can-stache-key');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var SimpleObservable = require('can-simple-observable@2.0.1#can-simple-observable');
    var assign = require('can-util@3.11.2#js/assign/assign');
    ...
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var canReflectDeps = require('can-reflect-dependencies@1.0.0#can-reflect-dependencies');
    var encoder = require('can-attribute-encoder@1.0.0#can-attribute-encoder');
    var queues = require('can-queues@1.0.0#can-queues');
    var SettableObservable = require('can-simple-observable@2.0.1#setter/setter');
    var AttributeObservable = require('can-stache-bindings@4.0.5#attribute-observable/attribute-observable');
    var makeCompute = require('can-view-scope@4.0.1#make-compute-like');
    var canEvent = require('can-stache-bindings@4.0.5#can-event');
    var noop = function () {
    };
...
define('can-simple-observable@2.0.1#resolver/resolver', [
    ...
    var Observation = require('can-observation@4.0.0#can-observation');
    var queues = require('can-queues@1.0.0#can-queues');
    var mapEventBindings = require('can-event-queue@1.0.0#map/map');
    var SettableObservable = require('can-simple-observable@2.0.1#settable/settable');
    var SimpleObservable = require('can-simple-observable@2.0.1#can-simple-observable');
    var getChangesSymbol = canSymbol.for('can.getChangesDependencyRecord');
...
define('can-define@2.0.1#can-define', [
    ...
    var Observation = require('can-observation@4.0.0#can-observation');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var AsyncObservable = require('can-simple-observable@2.0.1#async/async');
    var SettableObservable = require('can-simple-observable@2.0.1#settable/settable');
    var ResolverObservable = require('can-simple-observable@2.0.1#resolver/resolver');
    var eventQueue = require('can-event-queue@1.0.0#map/map');
    var addTypeEvents = require('can-event-queue@1.0.0#type/type');
    var queues = require('can-queues@1.0.0#can-queues');
    var isEmptyObject = require('can-util@3.11.2#js/is-empty-object/is-empty-object');
    var assign = require('can-util@3.11.2#js/assign/assign');
    var canLogDev = require('can-log@1.0.0#dev/dev');
    var isPlainObject = require('can-util@3.11.2#js/is-plain-object/is-plain-object');
    var each = require('can-util@3.11.2#js/each/each');
    var defaults = require('can-util@3.11.2#js/defaults/defaults');
    var stringToAny = require('can-util@3.11.2#js/string-to-any/string-to-any');
    var defineLazyValue = require('can-define-lazy-value@1.0.1#define-lazy-value');
...
define('can-define@2.0.1#define-helpers/define-helpers', [
    ...
    var define = require('can-define@2.0.1#can-define');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var queues = require('can-queues@1.0.0#can-queues');
    var defineHelpers = {
...
define('can-define@2.0.1#map/map', [
    ...
    var Construct = require('can-construct@3.3.0#can-construct');
    var define = require('can-define@2.0.1#can-define');
    var defineHelpers = require('can-define@2.0.1#define-helpers/define-helpers');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var ns = require('can-namespace@1.0.0#can-namespace');
    var canLog = require('can-log@1.0.0#can-log');
    var canLogDev = require('can-log@1.0.0#dev/dev');
    ...
    var canSymbol = require('can-symbol@1.6.0#can-symbol');
    var queues = require('can-queues@1.0.0#can-queues');
    var ensureMeta = require('can-define@2.0.1#ensure-meta');
    var dev = require('can-log@1.0.0#dev/dev');
    var addTypeEvents = require('can-event-queue@1.0.0#type/type');
...
define('can-component@4.0.1#can-component', [
    ...
    (function (global, require, exports, module) {
        var ComponentControl = require('can-component@4.0.1#control/control');
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var Construct = require('can-construct@3.3.0#can-construct');
        var stache = require('can-stache@4.0.2#can-stache');
        var stacheBindings = require('can-stache-bindings@4.0.5#can-stache-bindings');
        var Scope = require('can-view-scope@4.0.1#can-view-scope');
        var viewCallbacks = require('can-view-callbacks@4.0.0#can-view-callbacks');
        var nodeLists = require('can-view-nodelist@4.0.1#can-view-nodelist');
        var canReflect = require('can-reflect@1.13.2#can-reflect');
        var SimpleObservable = require('can-simple-observable@2.0.1#can-simple-observable');
        var SimpleMap = require('can-simple-map@4.0.0#can-simple-map');
        var DefineMap = require('can-define@2.0.1#map/map');
        var canLog = require('can-log@1.0.0#can-log');
        var canDev = require('can-log@1.0.0#dev/dev');
        var assign = require('can-assign@1.1.1#can-assign');
        require('can-view-model@4.0.0#can-view-model');
        var domData = require('can-dom-data-state@1.0.1#can-dom-data-state');
        var getChildNodes = require('can-util@3.11.2#dom/child-nodes/child-nodes');
        var string = require('can-util@3.11.2#js/string/string');
        var domEvents = require('can-dom-events@1.1.1#can-dom-events');
        var domMutate = require('can-dom-mutate@1.0.2#can-dom-mutate');
        var domMutateNode = require('can-dom-mutate@1.0.2#node');
...
define('can-connect@2.0.1#base/base', [
    ...
    var connect = require('can-connect@2.0.1#connect');
...
define('can-connect@2.0.1#can-connect', [
    ...
    var connect = require('can-connect@2.0.1#connect');
    var base = require('can-connect@2.0.1#base/base');
    var ns = require('can-namespace@1.0.0#can-namespace');
    connect.base = base;
...
define('can-set@1.5.1#src/compare', [
    ...
    var h = require('can-set@1.5.1#src/helpers');
    var assign = require('can-util@3.11.2#js/assign/assign');
    var each = require('can-util@3.11.2#js/each/each');
    var makeArray = require('can-util@3.11.2#js/make-array/make-array');
    var compareHelpers;
...
define('can-set@1.5.1#src/get', [
    ...
    var compare = require('can-set@1.5.1#src/compare');
    var h = require('can-set@1.5.1#src/helpers');
    var each = require('can-util@3.11.2#js/each/each');
...
define('can-set@1.5.1#src/set-core', [
    ...
    var h = require('can-set@1.5.1#src/helpers');
    var clause = require('can-set@1.5.1#src/clause');
    var compare = require('can-set@1.5.1#src/compare');
    var get = require('can-set@1.5.1#src/get');
    var assign = require('can-assign@1.1.1#can-assign');
    var each = require('can-util@3.11.2#js/each/each');
    var makeArray = require('can-util@3.11.2#js/make-array/make-array');
    var isEmptyObject = require('can-util@3.11.2#js/is-empty-object/is-empty-object');
    var getProp = require('can-util@3.11.2#js/get/get');
...
define('can-set@1.5.1#src/set', [
    ...
    var set = require('can-set@1.5.1#src/set-core');
    var ns = require('can-namespace@1.0.0#can-namespace');
    var props = require('can-set@1.5.1#src/props');
    var clause = require('can-set@1.5.1#src/clause');
    set.comparators = props;
    set.props = props;
    set.helpers = require('can-set@1.5.1#src/helpers');
    set.clause = clause;
...
define('can-connect@2.0.1#helpers/validate', [
    'require',
    'exports',
    'module',
    'can-validate-interface@1.0.0#index'
], function (require, exports, module) {
    var makeInterfaceValidator = require('can-validate-interface@1.0.0#index');
...
define('can-connect@2.0.1#cache-requests/cache-requests', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    var connect = require('can-connect@2.0.1#can-connect');
    var getItems = require('can-connect@2.0.1#helpers/get-items');
    var canSet = require('can-set@1.5.1#src/set');
    var forEach = [].forEach;
    ...
    var validate = require('can-connect@2.0.1#helpers/validate');
...
define('can-connect@2.0.1#helpers/weak-reference-map', [
    'require',
    'exports',
    'module',
    'can-util@3.11.2#js/assign/assign'
...
define('can-connect@2.0.1#helpers/id-merge', function (require, exports, module) {
    var map = [].map;
...
define('can-connect@2.0.1#constructor/constructor', [
    'require',
    'exports',
    'module',
    'can-util@3.11.2#js/make-array/make-array',
    ...
    var assign = require('can-util@3.11.2#js/assign/assign');
    var connect = require('can-connect@2.0.1#can-connect');
    var WeakReferenceMap = require('can-connect@2.0.1#helpers/weak-reference-map');
    var overwrite = require('can-connect@2.0.1#helpers/overwrite');
    var idMerge = require('can-connect@2.0.1#helpers/id-merge');
...
define('can-connect@2.0.1#constructor/callbacks-once/callbacks-once', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    var connect = require('can-connect@2.0.1#can-connect');
    var sortedSetJSON = require('can-connect@2.0.1#helpers/sorted-set-json');
    var forEach = [].forEach;
    var callbacks = [
        'createdInstance',
        'updatedInstance',
...
define('can-connect@2.0.1#helpers/weak-reference-set', [
    'require',
    'exports',
    'module',
    'can-util@3.11.2#js/assign/assign'
...
define('can-connect@2.0.1#constructor/store/store', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    var connect = require('can-connect@2.0.1#can-connect');
    var WeakReferenceMap = require('can-connect@2.0.1#helpers/weak-reference-map');
    var WeakReferenceSet = require('can-connect@2.0.1#helpers/weak-reference-set');
    var sortedSetJSON = require('can-connect@2.0.1#helpers/sorted-set-json');
    var eventQueue = require('can-event-queue@1.0.0#map/map');
...
define('can-connect@2.0.1#data/callbacks/callbacks', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
...
define('can-connect@2.0.1#data/callbacks-cache/callbacks-cache', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
...
define('can-connect@2.0.1#helpers/deferred', function (require, exports, module) {
...
define('can-connect@2.0.1#data/combine-requests/combine-requests', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    var getItems = require('can-connect@2.0.1#helpers/get-items');
    var deepAssign = require('can-util@3.11.2#js/deep-assign/deep-assign');
    var makeDeferred = require('can-connect@2.0.1#helpers/deferred');
    var forEach = [].forEach;
...
define('can-connect@2.0.1#data/localstorage-cache/localstorage-cache', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#helpers/get-items',
    ...
    var forEach = [].forEach;
    var map = [].map;
    var setAdd = require('can-connect@2.0.1#helpers/set-add');
    var indexOf = require('can-connect@2.0.1#helpers/get-index-by-id');
    var assign = require('can-util@3.11.2#js/assign/assign');
    var overwrite = require('can-connect@2.0.1#helpers/overwrite');
...
define('can-connect@2.0.1#data/memory-cache/memory-cache', [
    ...
    var indexOf = require('can-connect@2.0.1#helpers/get-index-by-id');
    var assign = require('can-util@3.11.2#js/assign/assign');
    var cloneData = require('can-connect@2.0.1#helpers/clone-data');
...
define('can-connect@2.0.1#data/parse/parse', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    var connect = require('can-connect@2.0.1#can-connect');
    var each = require('can-util@3.11.2#js/each/each');
    var getObject = require('can-util@3.11.2#js/get/get');
...
define('can-ajax@1.1.4#can-ajax', [
    ...
    (function (global, require, exports, module) {
        ...
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var parseURI = require('can-parse-uri@1.0.1#can-parse-uri');
        var param = require('can-param@1.0.2#can-param');
        var xhrs = [
                function () {
...
define('can-connect@2.0.1#helpers/get-id-props', function (require, exports, module) {
...
define('can-util@3.11.2#js/make-promise/make-promise', [
    ...
    'use strict';
    var isPromiseLike = require('can-util@3.11.2#js/is-promise-like/is-promise-like');
    var isPromise = require('can-util@3.11.2#js/is-promise/is-promise');
    module.exports = function (obj) {
...
define('can-connect@2.0.1#data/url/url', [
    'require',
    'exports',
    'module',
    'can-util@3.11.2#js/assign/assign',
    ...
    var assign = require('can-util@3.11.2#js/assign/assign');
    var each = require('can-util@3.11.2#js/each/each');
    var ajax = require('can-ajax@1.1.4#can-ajax');
    var string = require('can-util@3.11.2#js/string/string');
    var getIdProps = require('can-connect@2.0.1#helpers/get-id-props');
    var dev = require('can-util@3.11.2#js/dev/dev');
    var connect = require('can-connect@2.0.1#can-connect');
    var makeRest = require('can-make-rest@0.1.3#can-make-rest');
    var defaultRest = makeRest('/resource/{id}');
    var makePromise = require('can-util@3.11.2#js/make-promise/make-promise');
...
define('can-util@3.11.2#js/log/log', [
    ...
    'use strict';
    module.exports = require('can-log@1.0.0#can-log');
});
/*can-connect@2.0.1#fall-through-cache/fall-through-cache*/
define('can-connect@2.0.1#fall-through-cache/fall-through-cache', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    var connect = require('can-connect@2.0.1#can-connect');
    var sortedSetJSON = require('can-connect@2.0.1#helpers/sorted-set-json');
    var canLog = require('can-util@3.11.2#js/log/log');
...
define('can-connect@2.0.1#real-time/real-time', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
...
define('can-connect@2.0.1#can/map/map', [
    'require',
    'exports',
    'module',
    'can-util@3.11.2#js/each/each',
...
define('can-connect@2.0.1#can/ref/ref', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    var WeakReferenceMap = require('can-connect@2.0.1#helpers/weak-reference-map');
    var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
    var constructorStore = require('can-connect@2.0.1#constructor/store/store');
    var define = require('can-define@2.0.1#can-define');
...
define('can-util@3.11.2#js/global/global', [
    ...
    (function (global, require, exports, module) {
        'use strict';
        module.exports = require('can-globals@1.0.0#global/global');
    }(function () {
        return this;
    }(), require, exports, module));
});
/*can-connect@2.0.1#can/super-map/super-map*/
define('can-connect@2.0.1#can/super-map/super-map', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
    ...
    (function (global, require, exports, module) {
        var connect = require('can-connect@2.0.1#can-connect');
        var constructor = require('can-connect@2.0.1#constructor/constructor');
        var canMap = require('can-connect@2.0.1#can/map/map');
        var canRef = require('can-connect@2.0.1#can/ref/ref');
        var constructorStore = require('can-connect@2.0.1#constructor/store/store');
        var dataCallbacks = require('can-connect@2.0.1#data/callbacks/callbacks');
        var callbacksCache = require('can-connect@2.0.1#data/callbacks-cache/callbacks-cache');
        var combineRequests = require('can-connect@2.0.1#data/combine-requests/combine-requests');
        var localCache = require('can-connect@2.0.1#data/localstorage-cache/localstorage-cache');
        var dataParse = require('can-connect@2.0.1#data/parse/parse');
        var dataUrl = require('can-connect@2.0.1#data/url/url');
        var fallThroughCache = require('can-connect@2.0.1#fall-through-cache/fall-through-cache');
        var realTime = require('can-connect@2.0.1#real-time/real-time');
        var callbacksOnce = require('can-connect@2.0.1#constructor/callbacks-once/callbacks-once');
        var GLOBAL = require('can-util@3.11.2#js/global/global');
        var $ = GLOBAL().$;
...
define('can-connect@2.0.1#can/tag/tag', [
    'require',
    'exports',
    'module',
    'can-stache-bindings@4.0.5#can-stache-bindings',
    ...
    require('can-stache-bindings@4.0.5#can-stache-bindings');
    var connect = require('can-connect@2.0.1#can-connect');
    var Observation = require('can-observation@4.0.0#can-observation');
    var expression = require('can-stache@4.0.2#src/expression');
    var viewCallbacks = require('can-view-callbacks@4.0.0#can-view-callbacks');
...
define('can-connect@2.0.1#can/base-map/base-map', [
    'require',
    'exports',
    'module',
    'can-connect@2.0.1#can-connect',
...
define('can-connect@2.0.1#all', [
    ...
    var connect = require('can-connect@2.0.1#can-connect');
    connect.cacheRequests = require('can-connect@2.0.1#cache-requests/cache-requests');
    connect.constructor = require('can-connect@2.0.1#constructor/constructor');
    connect.constructorCallbacksOnce = require('can-connect@2.0.1#constructor/callbacks-once/callbacks-once');
    connect.constructorStore = require('can-connect@2.0.1#constructor/store/store');
    connect.dataCallbacks = require('can-connect@2.0.1#data/callbacks/callbacks');
    connect.dataCallbacksCache = require('can-connect@2.0.1#data/callbacks-cache/callbacks-cache');
    connect.dataCombineRequests = require('can-connect@2.0.1#data/combine-requests/combine-requests');
    connect.dataLocalStorageCache = require('can-connect@2.0.1#data/localstorage-cache/localstorage-cache');
    connect.dataMemoryCache = require('can-connect@2.0.1#data/memory-cache/memory-cache');
    connect.dataParse = require('can-connect@2.0.1#data/parse/parse');
    connect.dataUrl = require('can-connect@2.0.1#data/url/url');
    connect.fallThroughCache = require('can-connect@2.0.1#fall-through-cache/fall-through-cache');
    connect.realTime = require('can-connect@2.0.1#real-time/real-time');
    connect.superMap = require('can-connect@2.0.1#can/super-map/super-map');
    connect.tag = require('can-connect@2.0.1#can/tag/tag');
    connect.baseMap = require('can-connect@2.0.1#can/base-map/base-map');
    module.exports = connect;
});
...
define('can-route@4.0.1#src/register', [
    ...
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var dev = require('can-log@1.0.0#dev/dev');
    var bindingProxy = require('can-route@4.0.1#src/binding-proxy');
    var regexps = require('can-route@4.0.1#src/regexps');
    var diff = require('can-util@3.11.2#js/diff/diff');
    var diffObject = require('can-util@3.11.2#js/diff-object/diff-object');
...
define('can-route@4.0.1#src/deparam', [
    ...
    var deparam = require('can-deparam@1.0.3#can-deparam');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var bindingProxy = require('can-route@4.0.1#src/binding-proxy');
    var register = require('can-route@4.0.1#src/register');
...
define('can-route@4.0.1#src/url-helpers', [
    ...
    var bindingProxy = require('can-route@4.0.1#src/binding-proxy');
    var routeDeparam = require('can-route@4.0.1#src/deparam');
    var routeParam = require('can-route@4.0.1#src/param');
    var canReflect = require('can-reflect@1.13.2#can-reflect');
    var string = require('can-util@3.11.2#js/string/string');
...
define('can-route@4.0.1#src/hashchange', [
    ...
    (function (global, require, exports, module) {
        var paramsMatcher = /^(?:&[^=]+=[^&]*)+/;
        var LOCATION = require('can-globals@1.0.0#location/location');
        var canReflect = require('can-reflect@1.13.2#can-reflect');
        var ObservationRecorder = require('can-observation-recorder@1.0.1#can-observation-recorder');
        var queues = require('can-queues@1.0.0#can-queues');
        var KeyTree = require('can-key-tree@1.0.0#can-key-tree');
...
define('can-route@4.0.1#can-route', [
    ...
    (function (global, require, exports, module) {
        ...
        var Observation = require('can-observation@4.0.0#can-observation');
        var namespace = require('can-namespace@1.0.0#can-namespace');
        var devLog = require('can-log@1.0.0#dev/dev');
        var canReflect = require('can-reflect@1.13.2#can-reflect');
        var canSymbol = require('can-symbol@1.6.0#can-symbol');
        var makeCompute = require('can-simple-observable@2.0.1#make-compute/make-compute');
        var SimpleMap = require('can-simple-map@4.0.0#can-simple-map');
        var registerRoute = require('can-route@4.0.1#src/register');
        var urlHelpers = require('can-route@4.0.1#src/url-helpers');
        var routeParam = require('can-route@4.0.1#src/param');
        var routeDeparam = require('can-route@4.0.1#src/deparam');
        var bindingProxy = require('can-route@4.0.1#src/binding-proxy');
        var hashchange = require('can-route@4.0.1#src/hashchange');
        var isWebWorker = require('can-globals@1.0.0#is-web-worker/is-web-worker');
        var isBrowserWindow = require('can-globals@1.0.0#is-browser-window/is-browser-window');
...
define('can-stache-route-helpers@0.1.3#can-stache-route-helpers', [
    'require',
    'exports',
    'module',
    'can-stache@4.0.2#helpers/core',
    ...
    var helpers = require('can-stache@4.0.2#helpers/core');
    var route = require('can-route@4.0.1#can-route');
    var stacheExpression = require('can-stache@4.0.2#src/expression');
    var each = require('can-util@3.11.2#js/each/each');
...
define('can@4.0.1#can', [
    ...
    (function (global, require, exports, module) {
        var can = require('can-util@3.11.2#namespace');
        require('can-assign@1.1.1#can-assign');
        require('can-component@4.0.1#can-component');
        require('can-connect@2.0.1#all');
        require('can-define@2.0.1#map/map');
        require('can-define@2.0.1#list/list');
        require('can-route@4.0.1#can-route');
        require('can-set@1.5.1#src/set');
        require('can-simple-observable@2.0.1#can-simple-observable');
        require('can-stache@4.0.2#can-stache');
        require('can-stache-route-helpers@0.1.3#can-stache-route-helpers');
        require('can-stache-bindings@4.0.5#can-stache-bindings');
        require('can-attribute-encoder@1.0.0#can-attribute-encoder');
        require('can-ajax@1.1.4#can-ajax');
        require('can-globals@1.0.0#can-globals');
        require('can-reflect@1.13.2#can-reflect');
        require('can-define-lazy-value@1.0.1#define-lazy-value');
        require('can-dom-events@1.1.1#can-dom-events');
        require('can-event-dom-enter@2.1.0#can-event-dom-enter');
        require('can-event-dom-radiochange@2.1.0#can-event-dom-radiochange');
        require('can-parse-uri@1.0.1#can-parse-uri');
        require('can-validate-interface@1.0.0#index');
        require('can-view-model@4.0.0#can-view-model');
        module.exports = can;
    }(function () {
        return this;
