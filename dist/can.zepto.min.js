...
define("can/util/batch/batch",["can/util/can"],function(t){var n=1,c=0,i=[],a=[],h=null;t.batch={start:function(t){c++,t&&a.push(t)},stop:function(l,u){if(l?c=0:c--,0===c){if(null!==h)return;h=i.slice(0);var e,f,r=a.slice(0);for(i=[],a=[],t.batch.batchNum=n,n++,u&&t.batch.start(),e=0;e<h.length;e++)t.dispatch.apply(h[e][0],h[e][1]);for(h=null,e=0,f=r.length;e<r.length;e++)r[e]();t.batch.batchNum=void 0}},trigger:function(a,l,u){if(!a._init)if(l="string"==typeof l?{type:l}:l,h)h.push([a,[l,u]]);else{if(0===c)return t.dispatch.call(a,l,u);l.batchNum=n,i.push([a,[l,u]])}}}});
/*can@2.2.1#map/map*/
...
define("can/compute/read",["can/util/util"],function(e){var t=function(r,o,s){s=s||{};for(var a,u,i,d={foundObservable:!1},f=n(r,0,o,s,d),c=o.length,l=0;c>l;){u=f;for(var v=0,b=t.propertyReaders.length;b>v;v++){var p=t.propertyReaders[v];if(p.test(f)){f=p.read(f,o[l],l,s,d);break}}if(l+=1,f=n(f,l,o,s,d),a=typeof f,l<o.length&&(null===f||"function"!==a&&"object"!==a))return s.earlyExit&&s.earlyExit(u,l-1,f),{value:void 0,parent:u}}return"function"!=typeof f||e.Construct&&f.prototype instanceof e.Construct||e.route&&f===e.route||(s.isArgument?f.isComputed||s.proxyMethods===!1||(f=e.proxy(f,u)):(f.isComputed&&!i&&s.foundObservable&&s.foundObservable(f,l),f=f.call(u))),void 0===f&&s.earlyExit&&s.earlyExit(u,l-1),{value:f,parent:u}},n=function(e,n,r,o,s){for(var a=0,u=t.valueReaders.length;u>a;a++)t.valueReaders[a].test(e,n,r,o)&&(e=t.valueReaders[a].read(e,n,r,o,s));return e};return t.valueReaders=[{test:function(e,t,n,r){return e&&e.isComputed&&!r.isArgument&&t<n.length},read:function(t,n,r,o,s){return!s.foundObservable&&o.foundObservable&&(o.foundObservable(t,n),s.foundObservable=!0),t instanceof e.Compute?t.get():t()}},{test:function(t,n,r,o){var s=typeof t;return n<r.length&&"function"===s&&o.executeAnonymousFunctions&&!(e.Construct&&t.prototype instanceof e.Construct)},read:function(e){return e()}}],t.propertyReaders=[{test:e.isMapLike,read:function(t,n,r,o,s){return!s.foundObservable&&o.foundObservable&&(o.foundObservable(t,r),s.foundObservable=!0),"function"==typeof t[n]&&t.constructor.prototype[n]===t[n]?o.returnObserveMethods?t[n]:"constructor"===n&&t instanceof e.Construct||t[n].prototype instanceof e.Construct?t[n]:t[n].apply(t,o.args||[]):t.attr(n)}},{test:function(t){return e.isPromise(t)},read:function(t,n,r,o,s){!s.foundObservable&&o.foundObservable&&(o.foundObservable(t,r),s.foundObservable=!0);var a=t.__observeData;return t.__observeData||(a=t.__observeData={isPending:!0,state:"pending",isResolved:!1,isRejected:!1},e.simpleExtend(a,e.event),t.then(function(e){a.isPending=!1,a.isResolved=!0,a.value=e,a.state="resolved",a.dispatch("state",["resolved","pending"])},function(e){a.isPending=!1,a.isRejected=!0,a.reason=e,a.state="rejected",a.dispatch("state",["rejected","pending"])})),e.__reading(a,"state"),a[n]}},{test:function(){return!0},read:function(e,t){return null==e?void 0:e[t]}}],t});
/*can@2.2.1#compute/proto_compute*/
define("can/compute/proto_compute",["can/util/util","can/util/bind/bind","can/compute/read","can/util/batch/batch"],function(t,e,n){var i=[];t.__read=function(t,e){i.push({});var n=t.call(e);return{value:n,observed:i.pop()}},t.__reading=function(t,e){i.length&&(i[i.length-1][t._cid+"|"+e]={obj:t,event:e+""})},t.__clearReading=function(){if(i.length){var t=i[i.length-1];return i[i.length-1]={},t}},t.__setReading=function(t){i.length&&(i[i.length-1]=t)},t.__addReading=function(e){i.length&&t.simpleExtend(i[i.length-1],e)};var o=function(e,n,i,o){var u=t.__read(e,n),r=u.observed;return s(i,r,o),a(i,o),t.bind.call(u,"ready",function(){u.ready=!0}),t.batch.trigger(u,"ready"),u},s=function(t,e,n){for(var i in e)u(t,e,i,n)},u=function(t,e,n,i){if(t[n])delete t[n];else{var o=e[n];o.obj.bind(o.event,i)}},a=function(t,e){for(var n in t){var i=t[n];i.obj.unbind(i.event,e)}},r=function(e,n,i,o){n!==i&&t.batch.trigger(e,o?{type:"change",batchNum:o}:"change",[n,i])},h=function(){this.readInfo=o(this._getterSetter,this._context,{},this.onchanged),this.setCached(this.readInfo.value),this.hasDependencies=!t.isEmptyObject(this.readInfo.observed)},c=function(){for(var t in this.readInfo.observed){var e=this.readInfo.observed[t];e.obj.unbind(e.event,this.onchanged)}},f=function(e,n,i){var s,u,a;return{on:function(){var r=this;u||(u=function(t){if(s.ready&&e.bound&&(void 0===t.batchNum||t.batchNum!==a)){var h=s.value;s=o(n,i,s.observed,u),r.updater(s.value,h,t.batchNum),a=a=t.batchNum}}),s=o(n,i,{},u),e.setCached(s.value),e.hasDependencies=!t.isEmptyObject(s.observed)},off:function(){for(var t in s.observed){var e=s.observed[t];e.obj.unbind(e.event,u)}}}},d=function(e,n,i){var s,u,a,r;return{on:function(h){a||(a=function(o){if(s.ready&&e.bound&&(void 0===o.batchNum||o.batchNum!==r)){var a=t.__clearReading(),c=n.call(i);t.__setReading(a),h.call(e,c,u,o.batchNum),u=c,r=r=o.batchNum}}),s=o(n,i,{},a),u=s.value,e.setCached(s.value),e.hasDependencies=!t.isEmptyObject(s.observed)},off:function(){for(var t in s.observed){var e=s.observed[t];e.obj.unbind(e.event,a)}}}},_=function(){},v=function(t,e,n){this.setCached(t),r(this,t,e,n)},p=function(t,e){return function(){e(t._get(),t.value)}},l=function(t,e,n){return function(){return t.call(e,n.get())}},g=function(t,e){return function(n){void 0!==n&&e(n,t.value)}};t.Compute=function(){for(var e=[],n=0,i=arguments.length;i>n;n++)e[n]=arguments[n];var o=typeof e[1];"function"==typeof e[0]?this._setupGetterSetterFn(e[0],e[1],e[2],e[3]):e[1]?"string"===o?this._setupContextString(e[0],e[1],e[2]):"function"===o?this._setupContextFunction(e[0],e[1],e[2]):e[1]&&e[1].fn?this._setupAsyncCompute(e[0],e[1]):this._setupContextSettings(e[0],e[1]):this._setupInitialValue(e[0]),this._args=e,this.isComputed=!0,t.cid(this,"compute")},t.simpleExtend(t.Compute.prototype,{_bindsetup:function(){this.bound=!0;var e=t.__clearReading();this._on(this.updater),t.__setReading(e)},_bindteardown:function(){this._off(this.updater),this.bound=!1},bind:t.bindAndSetup,unbind:t.unbindAndTeardown,clone:function(e){return e&&"function"==typeof this._args[0]?this._args[1]=e:e&&(this._args[2]=e),new t.Compute(this._args[0],this._args[1],this._args[2],this._args[3])},_on:_,_off:_,get:function(){return i.length&&this._canReadForChangeEvent!==!1&&(t.__reading(this,"change"),this.bound||t.Compute.temporarilyBind(this)),this.bound?this.value:this._get()},_get:function(){return this.value},set:function(t){var e=this.value,n=this._set(t,e);return this.hasDependencies?this._setUpdates?this.value:this._get():(this.value=void 0===n?this._get():n,r(this,this.value,e),this.value)},_set:function(t){return this.value=t},setCached:function(t){this.value=t},updater:v,_computeFn:function(t){return arguments.length?this.set(t):this.get()},toFunction:function(){return t.proxy(this._computeFn,this)},_setupGetterSetterFn:function(e,n,i,s){this._set=t.proxy(e,n),this._get=t.proxy(e,n),this._canReadForChangeEvent=i===!1?!1:!0,this._getterSetter=e,this._context=n;var u;if(s)u=d(this,e,n||this),this._on=u.on,this._off=u.off;else{var a=this;this.onchanged=function(t){if(a.bound&&a.readInfo.ready&&(void 0===t.batchNum||t.batchNum!==a.batchNum)){var i=a.readInfo.value;a.readInfo=o(e,n,a.readInfo.observed,a.onchanged),a.updater(a.readInfo.value,i,t.batchNum),a.batchNum=t.batchNum}},this._on=h,this._off=c}},_setupContextString:function(e,n,i){var o,s=e instanceof t.Map;this.updater=t.proxy(this.updater,this),s?(this.hasDependencies=!0,this._get=function(){return e.attr(n)},this._set=function(t){e.attr(n,t)},this._on=function(s){o=function(t,e,n){s(e,n,t.batchNum)},e.bind(i||n,o),this.value=t.__read(this._get).value},this._off=function(){return e.unbind(i||n,o)}):(this._get=t.proxy(this._get,e),this._set=t.proxy(this._set,e))},_setupContextFunction:function(e,n,i){this.value=e,this._set=n,t.simpleExtend(this,i)},_setupContextSettings:function(e,n){this.value=e;var i=t.proxy(this.updater,this);this._set=n.set?t.proxy(n.set,n):this._set,this._get=n.get?t.proxy(n.get,n):this._get,this.updater=p(this,i),this._on=n.on?n.on:this._on,this._off=n.off?n.off:this._off},_setupAsyncCompute:function(e,n){this.value=e;var i,o=t.proxy(this.updater,this),s=this,u=n.fn;this.updater=o;var a=new t.Compute(e);this.lastSetValue=a,this._setUpdates=!0,this._set=function(t){return t===a.get()?this.value:void a.set(t)},this._get=l(u,n.context,a),0===u.length?i=f(this,u,n.context):1===u.length?i=f(this,function(){return u.call(n.context,a.get())},n):(this.updater=g(this,o),i=f(this,function(){var t=u.call(n.context,a.get(),function(t){o(t,s.value)});return void 0!==t?t:this.value},n)),this._on=i.on,this._off=i.off},_setupInitialValue:function(t){this.value=t}});var b,m=function(){for(var t=0,e=b.length;e>t;t++)b[t].unbind("change",_);b=null};return t.Compute.temporarilyBind=function(t){t.bind("change",_),b||(b=[],setTimeout(m,10)),b.push(t)},t.Compute.async=function(e,n,i){return new t.Compute(e,{fn:n,context:i})},t.Compute.read=n,t.Compute.truthy=function(e){return new t.Compute(function(){var t=e.get();return"function"==typeof t&&(t=t.get()),!!t})},t.Compute.set=function(e,n,i){return t.isMapLike(e)?e.attr(n,i):e[n]&&e[n].isComputed?e[n](i):void("object"==typeof e&&(e[n]=i))},t.Compute});
