...
/*can-component@4.2.2#control/control*/
...
/*can-diff@1.2.0#patcher/patcher*/
...
/*can-string-to-any@1.0.3#can-string-to-any*/
...
/*can-data-types@1.0.0#maybe-boolean/maybe-boolean*/
...
/*can-data-types@1.0.0#maybe-date/maybe-date*/
...
/*can-data-types@1.0.0#maybe-number/maybe-number*/
...
/*can-data-types@1.0.0#maybe-string/maybe-string*/
    ...
    define.property = function (typePrototype, prop, definition, dataInitializers, computedInitializers, defaultDefinition) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            if (type && canReflect.isConstructorLike(type) && !isDefineType(type)) {
                canLogDev.warn('can-define: the definition for ' + prop + (typePrototype.constructor.shortName ? ' on ' + typePrototype.constructor.shortName : '') + ' uses a constructor for "type". Did you mean "Type"?');
            }
        }
        ...
        if (definition.get && definition.set) {
            ...
            setter = function () {
                if (process.env.NODE_ENV !== 'production') {
                    canLogDev.warn('can-define: Set value for property ' + prop + (typePrototype.constructor.shortName ? ' on ' + typePrototype.constructor.shortName : '') + ' ignored, as its definition has a zero-argument getter and no setter');
                }
            };
        }
        if (type) {
...
/*can-component@4.2.2#can-component*/
...
/*can-connect@2.1.0#cache-requests/cache-requests*/
...
/*can-connect@2.1.0#constructor/callbacks-once/callbacks-once*/
...
/*can-connect@2.1.0#helpers/weak-reference-set*/
...
/*can-connect@2.1.0#constructor/store/store*/
...
/*can-connect@2.1.0#data/callbacks/callbacks*/
...
/*can-connect@2.1.0#data/callbacks-cache/callbacks-cache*/
...
/*can-connect@2.1.0#helpers/deferred*/
...
/*can-connect@2.1.0#data/combine-requests/combine-requests*/
...
/*can-connect@2.1.0#data/localstorage-cache/localstorage-cache*/
...
/*can-connect@2.1.0#fall-through-cache/fall-through-cache*/
...
/*can-connect@2.1.0#real-time/real-time*/
...
define('can-connect/can/ref/ref', [
    ...
    var makeRef = function (connection) {
        ...
        canReflect.assignSymbols(Ref.prototype, { 'can.serialize': Ref.prototype.serialize });
...
/*can-util@3.12.0#js/global/global*/
...
/*can-connect@2.1.0#can/super-map/super-map*/
...
/*can-connect@2.1.0#can/base-map/base-map*/
...
/*can-event-dom-enter@2.2.0#add-global/add-global*/
...
/*can-simple-observable@2.2.0#key/key*/
