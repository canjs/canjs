...
define("can/component/component",["can/util/util","can/view/callbacks/callbacks","can/control/control","can/observe/observe","can/view/mustache/mustache","can/view/bindings/bindings"],function(t,e){var n=/^(dataViewId|class|id)$/i,o=/\{([^\}]+)\}/g,i=t.Component=t.Construct.extend({setup:function(){if(t.Construct.setup.apply(this,arguments),t.Component){var e=this,n=this.prototype.scope||this.prototype.viewModel;if(this.Control=s.extend(this.prototype.events),n&&("object"!=typeof n||n instanceof t.Map)?n.prototype instanceof t.Map&&(this.Map=n):this.Map=t.Map.extend(n||{}),this.attributeScopeMappings={},t.each(this.Map?this.Map.defaults:{},function(t,n){"@"===t&&(e.attributeScopeMappings[n]=n)}),this.prototype.template)if("function"==typeof this.prototype.template){var o=this.prototype.template;this.renderer=function(){return t.view.frag(o.apply(null,arguments))}}else this.renderer=t.view.mustache(this.prototype.template);t.view.tag(this.prototype.tag,function(t,n){new e(t,n)})}}},{setup:function(o,i){var s,a,c={},r=this,p=("undefined"==typeof this.leakScope?!1:!this.leakScope)&&this.template,u={},l=this.scope||this.viewModel,h={};if(t.each(this.constructor.attributeScopeMappings,function(e,n){c[n]=o.getAttribute(t.hyphenate(e))}),t.each(t.makeArray(o.attributes),function(a){var p=t.camelize(a.nodeName.toLowerCase()),l=a.value;if(!(r.constructor.attributeScopeMappings[p]||n.test(p)||e.attr(a.nodeName))){if("{"===l[0]&&"}"===l[l.length-1])l=l.substr(1,l.length-2);else if("legacy"!==i.templateType)return void(c[p]=l);var d=i.scope.computeData(l,{args:[]}),f=d.compute,m=function(e,n){h[p]=(h[p]||0)+1;var o=function(){--h[p],t.unbind.call(h,"ready",o)};t.bind.call(h,"ready",o),s.attr(p,n),t.batch.trigger(h,"ready")};f.bind("change",m),c[p]=f(),f.computeInstance.hasDependencies?(t.bind.call(o,"removed",function(){f.unbind("change",m)}),u[p]=d):f.unbind("change",m)}}),this.constructor.Map)s=new this.constructor.Map(c);else if(l instanceof t.Map)s=l;else if(t.isFunction(l)){var d=l.call(this,c,i.scope,o);s=d instanceof t.Map?d:d.prototype instanceof t.Map?new d(c):new(t.Map.extend(d))(c)}var f={};t.each(u,function(t,e){f[e]=function(n,o){h[e]||t.compute(o)},s.bind(e,f[e])}),t.isEmptyObject(this.constructor.attributeScopeMappings)&&"legacy"===i.templateType||t.bind.call(o,"attributes",function(e){var i=t.camelize(e.attributeName);u[i]||n.test(i)||s.attr(i,o.getAttribute(e.attributeName))}),this.scope=this.viewModel=s,t.data(t.$(o),"scope",this.scope),t.data(t.$(o),"viewModel",this.scope);var m=p?this.scope:i.scope.add(this.scope),g={helpers:{}};t.each(this.helpers||{},function(e,n){t.isFunction(e)&&(g.helpers[n]=function(){return e.apply(s,arguments)})});var v=function(){t.each(f,function(t,e){s.unbind(e,f[e])})};if(this._control=new this.constructor.Control(o,{scope:this.scope,viewModel:this.scope}),this._control&&this._control.destroy){var b=this._control.destroy;this._control.destroy=function(){b.apply(this,arguments),v()},this._control.on()}else t.bind.call(o,"removed",function(){v()});this.constructor.renderer?(g.tags||(g.tags={}),g.tags.content=function y(e,n){var o=i.subtemplate||n.subtemplate;if(o){delete g.tags.content;var s=p&&o===i.subtemplate?i:n;t.view.live.replace([e],o(s.scope,s.options)),g.tags.content=y}},a=this.constructor.renderer(m,i.options.add(g))):a="legacy"===i.templateType?t.view.frag(i.subtemplate?i.subtemplate(m,i.options.add(g)):""):i.subtemplate?i.subtemplate(m,i.options.add(g)):document.createDocumentFragment(),t.appendChild(o,a)}}),s=t.Control.extend({_lookup:function(t){return[t.scope,t,window]},_action:function(e,n,i){var s,a;if(o.lastIndex=0,s=o.test(e),i||!s){if(s){a=t.compute(function(){var i,s=e.replace(o,function(e,o){var s;return"scope"===o||"viewModel"===o?(i=n.scope,""):(o=o.replace(/^(scope|^viewModel)\./,""),s=t.compute.read(n.scope,o.split("."),{isArgument:!0}).value,void 0===s&&(s=t.getObject(o)),"string"==typeof s?s:(i=s,""))}),a=s.split(/\s+/g),c=a.pop();return{processor:this.processors[c]||this.processors.click,parts:[s,a.join(" "),c],delegate:i||void 0}},this);var c=function(t,n){i._bindings.control[e](i.element),i._bindings.control[e]=n.processor(n.delegate||i.element,n.parts[2],n.parts[1],e,i)};return a.bind("change",c),i._bindings.readyComputes[e]={compute:a,handler:c},a()}return t.Control._action.apply(this,arguments)}}},{setup:function(e,n){return this.scope=n.scope,this.viewModel=n.viewModel,t.Control.prototype.setup.call(this,e,n)},off:function(){this._bindings&&t.each(this._bindings.readyComputes||{},function(t){t.compute.unbind("change",t.handler)}),t.Control.prototype.off.apply(this,arguments),this._bindings.readyComputes={}}}),a=t.$;return a.fn&&(a.fn.scope=a.fn.viewModel=function(){return t.viewModel.apply(t,[this].concat(t.makeArray(arguments)))}),i});
