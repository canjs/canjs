...
define("can/component/component",["can/util/util","can/view/callbacks/callbacks","can/view/elements","can/view/bindings/bindings","can/control/control","can/observe/observe","can/view/mustache/mustache","can/util/view_model/view_model"],function(e,t,o,n){var i=/^(dataViewId|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,s=/\{([^\}]+)\}/g,a=e.Component=e.Construct.extend({setup:function(){if(e.Construct.setup.apply(this,arguments),e.Component){var t=this,o=this.prototype.scope||this.prototype.viewModel;if(this.Control=p.extend(this.prototype.events),o&&("object"!=typeof o||o instanceof e.Map)?o.prototype instanceof e.Map&&(this.Map=o):this.Map=e.Map.extend(o||{}),this.attributeScopeMappings={},e.each(this.Map?this.Map.defaults:{},function(e,o){"@"===e&&(t.attributeScopeMappings[o]=o)}),this.prototype.template)if("function"==typeof this.prototype.template){var n=this.prototype.template;this.renderer=function(){return e.view.frag(n.apply(null,arguments))}}else this.renderer=e.view.mustache(this.prototype.template);e.view.tag(this.prototype.tag,function(e,o){new t(e,o)})}}},{setup:function(s,a){var p,r,c={"%root":a.scope.attr("%root")},u=this,l=("undefined"==typeof this.leakScope?!1:!this.leakScope)&&!!this.template,d={},h=this.scope||this.viewModel,m={},f=[],v=function(){for(var e=0,t=f.length;t>e;e++)f[e]()},g=e.$(s),y=!e.data(g,"preventDataBindings");if(e.each(this.constructor.attributeScopeMappings,function(t,o){c[o]=s.getAttribute(e.hyphenate(t))}),y&&e.each(e.makeArray(s.attributes),function(o,r){var l=o.name,h=e.camelize(l.toLowerCase()),f=o.value,v=n.dataBindingsRegExp.test(l);if(!(u.constructor.attributeScopeMappings[h]||i.test(h)||t.attr(l)&&!v)){if("{"===f[0]&&"}"===f[f.length-1])f=f.substr(1,f.length-2);else if(!v&&"legacy"!==a.templateType)return void(c[h]=f);var g=n.attributeNameInfo(l);g.propName=e.camelize(g.propName),d[g.propName]=g;var y=n.getParentCompute(s,a.scope,f,{templateType:a.templateType});if(y&&y.isComputed){if(g.parentToChild){n.bindParentToChild(s,y,function(e){p.attr(g.propName,e)},m,g.propName);var w=y();void 0!==w&&(c[g.propName]=w)}d[g.propName].parentCompute=y}else c[g.propName]=y}}),this.constructor.Map)p=new this.constructor.Map(c);else if(h instanceof e.Map)p=h;else if(e.isFunction(h)){var w=h.call(this,c,a.scope,s);p=w instanceof e.Map?w:w.prototype instanceof e.Map?new w(c):new(e.Map.extend(w))(c)}var b={};y&&e.each(d,function(t,o){t.childToParent&&(b[o]=function(e,n){m[o]||t.parentCompute(n)},p.bind(o,b[o]),"new"===t.syntaxStyle&&t.parentCompute&&n.initializeValues(t,"."===o?p:e.compute.read(p,e.compute.read.reads(o),{}).value,t.parentCompute,function(){},function(e,o){t.parentCompute(o)}))}),e.isEmptyObject(this.constructor.attributeScopeMappings)&&"legacy"===a.templateType||e.bind.call(s,"attributes",function(t){var o=e.camelize(t.attributeName);d[o]||i.test(o)||p.attr(o,s.getAttribute(t.attributeName))}),this.scope=this.viewModel=p,e.data(g,"scope",this.scope),e.data(g,"viewModel",this.scope),e.data(g,"preventDataBindings",!0);var M;M=l?e.view.Scope.refsScope().add(this.scope,{viewModel:!0}):(this.constructor.renderer?a.scope.add(new e.view.Scope.Refs):a.scope).add(this.scope,{viewModel:!0});var C={helpers:{}},N=function(e,t){C.helpers[e]=function(){return t.apply(p,arguments)}};e.each(this.helpers||{},function(t,o){e.isFunction(t)&&N(o,t)}),e.each(this.simpleHelpers||{},function(t,o){N(o,e.view.simpleHelper(t))}),f.push(function(){e.each(b,function(e,t){p.unbind(t,b[t])})}),this._control=new this.constructor.Control(s,{scope:this.scope,viewModel:this.scope,destroy:v});var _=e.view.nodeLists.register([],void 0,!0);f.push(function(){e.view.nodeLists.unregister(_)}),this.constructor.renderer?(C.tags||(C.tags={}),C.tags.content=function S(t,n){var i=a.subtemplate||n.subtemplate,s=i===a.subtemplate;if(i){delete C.tags.content;var r;if(r=s?l?a:{scope:n.scope.cloneFromRef(),options:n.options}:n,r.scope=r.scope.add(p,{"protected":!0,viewModel:!0}),n.parentNodeList){var c=i(r.scope,r.options,n.parentNodeList);o.replace([t],c)}else e.view.live.replace([t],i(r.scope,r.options));C.tags.content=S}},r=this.constructor.renderer(M,a.options.add(C),_)):r="legacy"===a.templateType?e.view.frag(a.subtemplate?a.subtemplate(M,a.options.add(C)):""):a.subtemplate?a.subtemplate(M,a.options.add(C),_):document.createDocumentFragment(),e.appendChild(s,r,e.document),e.view.nodeLists.update(_,e.childNodes(s))}}),p=e.Control.extend({_lookup:function(e){return[e.scope,e,window]},_action:function(t,o,n){var i,a;if(s.lastIndex=0,i=s.test(t),n||!i){if(i){a=e.compute(function(){var n,i=t.replace(s,function(t,i){var s;return"scope"===i||"viewModel"===i?(n=o.scope,""):(i=i.replace(/^(scope|^viewModel)\./,""),s=e.compute.read(o.scope,e.compute.read.reads(i),{isArgument:!0}).value,void 0===s&&(s=e.getObject(i)),"string"==typeof s?s:(n=s,""))}),a=i.split(/\s+/g),p=a.pop();return{processor:this.processors[p]||this.processors.click,parts:[i,a.join(" "),p],delegate:n||void 0}},this);var p=function(e,o){n._bindings.control[t](n.element),n._bindings.control[t]=o.processor(o.delegate||n.element,o.parts[2],o.parts[1],t,n)};return a.bind("change",p),n._bindings.readyComputes[t]={compute:a,handler:p},a()}return e.Control._action.apply(this,arguments)}}},{setup:function(t,o){return this.scope=o.scope,this.viewModel=o.viewModel,e.Control.prototype.setup.call(this,t,o)},off:function(){this._bindings&&e.each(this._bindings.readyComputes||{},function(e){e.compute.unbind("change",e.handler)}),e.Control.prototype.off.apply(this,arguments),this._bindings.readyComputes={}},destroy:function(){e.Control.prototype.destroy.apply(this,arguments),"function"==typeof this.options.destroy&&this.options.destroy.apply(this,arguments)}}),r=e.$;return r.fn&&(r.fn.scope=r.fn.viewModel=function(){return e.viewModel.apply(e,[this].concat(e.makeArray(arguments)))}),a});
