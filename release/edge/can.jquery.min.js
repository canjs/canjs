var module={_orig:window.module};define=function(a,p,k){module[a]=k()};define.amd={jQuery:!0};module["can/util/can.js"]=function(){window.can=window.can||{};window.can.isDeferred=function(a){var p=this.isFunction;return a&&p(a.then)&&p(a.pipe)};return window.can}();module["can/util/preamble.js"]=function(){}();
