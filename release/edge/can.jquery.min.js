...
module["can/util/string/string.js"]=function(a){var p=/\=\=/,j=/([A-Z]+)([A-Z][a-z])/g,k=/([a-z\d])([A-Z])/g,h=/([a-z\d])([A-Z])/g,i=/\{([^\}]+)\}/g,o=/"/g,m=/'/g;a.extend(a,{esc:function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(o,"&#34;").replace(m,"&#39;")},getObject:function(c,b,g){var c=c?c.split("."):[],e=c.length,f,l=0,d,n,b=a.isArray(b)?b:[b||window];if(!e)return b[0];for(;f=b[l++];){for(n=0;n<e-1&&/^f|^o/.test(typeof f);n++)f=c[n]in f?f[c[n]]:
g&&(f[c[n]]={});if(/^f|^o/.test(typeof f)&&(d=c[n]in f?f[c[n]]:g&&(f[c[n]]={}),void 0!==d))return!1===g&&delete f[c[n]],d}},capitalize:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},underscore:function(a){return a.replace(p,"/").replace(j,"$1_$2").replace(k,"$1_$2").replace(h,"_").toLowerCase()},sub:function(c,b,g){var e=[];e.push(c.replace(i,function(c,l){var d=a.getObject(l,b,void 0===g?g:!g);return/^f|^o/.test(typeof d)?(e.push(d),""):""+d}));return 1>=e.length?e[0]:e},replacer:i,undHash:/_|-/});
...
(b=this.__convert(f,b));this.__set(f,b,e)}},__set:function(a,b,d){if(b!==d){var f=this.__get().hasOwnProperty(a)?"set":"add";this.___set(a,j(b)?h(b,a,this):b);c(this,"change",[a,f,b,d]);c(this,a,[b,d]);d&&k([d],this._cid)}},___set:function(a,b){this._data[a]=b;a in this.constructor.prototype||(this[a]=b)},bind:l,unbind:f,serialize:function(){return e(this,"serialize",{})},_attrs:function(b,c){if(void 0===b)return e(this,"attr",{});var b=a.extend(!0,{},b),d,f=m(),l=this,n;this.each(function(a,d){n=
b[d];void 0===n?c&&l.removeAttr(d):(j(a)&&j(n)&&a.attr?a.attr(n,c):a!=n&&l._set(d,n),delete b[d])});for(d in b)n=b[d],this._set(d,n);f&&g();return this}}),s=[].splice,v=n({setup:function(b,d){this.length=0;this._cid=".observe"+ ++i;this._init=1;this.bind("change",a.proxy(this._changes,this));this.push.apply(this,a.makeArray(b||[]));a.extend(this,d);delete this._init},_changes:function(a,b,d,f,e){~b.indexOf(".")||("add"===d?(c(this,d,[f,+b]),c(this,"length",[this.length])):"remove"===d?(c(this,d,[e,
...
return e},_attrs:function(b,d){if(void 0===b)return e(this,"attr",[]);var b=a.makeArray(b),f=Math.min(b.length,this.length),c=m(),n;for(n=0;n<f;n++){var l=this[n],h=b[n];j(l)&&j(h)?l.attr(h,d):l!=h&&this._set(n,h)}b.length>this.length?this.push.apply(this,b.slice(this.length)):b.length<this.length&&d&&this.splice(b.length);c&&g()}});a.each({push:"length",unshift:0},function(b,d){v.prototype[d]=function(){for(var f=arguments[0]&&a.isArray(arguments[0])?arguments[0]:a.makeArray(arguments),e=b?this.length:
0,g=0;g<f.length;g++){var n=f[g];j(n)&&(f[g]=h(n,"*",this))}g=[][d].apply(this,f);(!this.comparator||!f.length)&&c(this,"change",[""+e,"add",f,void 0]);return g}});a.each({pop:"length",shift:0},function(b,d){v.prototype[d]=function(){var f=arguments[0]&&a.isArray(arguments[0])?arguments[0]:a.makeArray(arguments),e=b&&this.length?this.length-1:0,f=[][d].apply(this,f);c(this,"change",[""+e,"remove",void 0,[f]]);f&&f.unbind&&f.unbind("change"+this._cid);return f}});a.extend(v.prototype,{indexOf:[].indexOf||
function(b){return a.inArray(b,this)},join:[].join,slice:function(){return new this.constructor(Array.prototype.slice.apply(this,arguments))},concat:function(){var b=[];a.each(arguments,function(d){b.push(d instanceof a.Observe.List?d.serialize():d)});return new this.constructor(Array.prototype.concat.apply(this.serialize(),b))},forEach:function(b,d){a.each(this,a.proxy(b,d||this))}});n.List=v;return n}(module["can/util/jquery/jquery.js"],module["can/construct/construct.js"]);
module["can/model/model.js"]=function(a){var p=function(c,b,g){var e=new a.Deferred;c.then(function(){arguments[0]=b[g](arguments[0]);e.resolveWith(e,arguments)},function(){e.rejectWith(this,arguments)});return e},j=0,k=/change.observe\d+/,h=function(a,b,g,e,f){var l;l=[a.serialize()];var d=a.constructor,n;"destroy"==b&&l.shift();"create"!==b&&l.unshift(a[a.constructor.id]);n=d[b].apply(d,l);l=n.pipe(function(d){a[f||b+"d"](d,n);return a});n.abort&&(l.abort=function(){n.abort()});return l.then(g,
e)},i={create:{url:"_shortName",type:"post"},update:{data:function(c,b){var b=b||{},g=this.id;b[g]&&b[g]!==c&&(b["new"+a.capitalize(c)]=b[g],delete b[g]);b[g]=c;return b},type:"put"},destroy:{type:"delete",data:function(a){var b={};b[this.id]=a;return b}},findAll:{url:"_shortName"},findOne:{}},o=function(c,b){return function(g){var g=c.data?c.data.apply(this,arguments):g,e=b||this[c.url||"_url"],f=g,l=c.type||"get";if("string"==typeof e){var d=e.split(" "),e={url:d.pop()};d.length&&(e.type=d.pop())}e.data=
"object"==typeof f&&!a.isArray(f)?a.extend(e.data||{},f):f;e.url=a.sub(e.url,e.data,!0);return a.ajax(a.extend({type:l||"post",dataType:"json",success:void 0,error:void 0},e))}};a.Model=a.Observe({fullName:"can.Model",setup:function(c){a.Observe.apply(this,arguments);if(a.Model){var b=this,g=a.proxy(this._clean,b);a.each(i,function(e,f){a.isFunction(b[f])||(b[f]=o(e,b[f]));if(b["make"+a.capitalize(f)]){var l=b["make"+a.capitalize(f)](b[f]);a.Construct._overwrite(b,c,f,function(){this._super;this._reqs++;
return l.apply(this,arguments).then(g,g)})}});if("can.Model"==b.fullName||!b.fullName)b.fullName="Model"+ ++j;this.store={};this._reqs=0;this._url=this._shortName+"/{"+this.id+"}"}},_ajax:o,_clean:function(){this._reqs--;if(!this._reqs)for(var a in this.store)this.store[a]._bindings||delete this.store[a]},models:function(c){if(c){if(c instanceof this.List)return c;var b=this,g=new (b.List||m),e=a.isArray(c),f=c instanceof m,f=e?c:f?c.serialize():c.data;a.each(f,function(a){g.push(b.model(a))});e||
...
function(a,e,g){c.push(e);return"([^\\"+(b.substr(g+a.length,1)||"&")+"]"+(f[e]?"*":"+")+")"});a.route.routes[b]={test:RegExp("^"+e+"($|&)"),route:b,names:c,defaults:f,length:b.split("/").length};return a.route};c(a.route,{param:function(b,f){var e,g=0,l,i=b.route,k=0;delete b.route;m(b,function(){k++});m(a.route.routes,function(a){l=h(a,b);l>g&&(e=a,g=l);if(l>=k)return!1});a.route.routes[i]&&h(a.route.routes[i],b)===g&&(e=a.route.routes[i]);if(e){var o=c({},b),i=e.route.replace(p,function(a,f){delete o[f];
return b[f]===e.defaults[f]?"":encodeURIComponent(b[f])}),j;m(e.defaults,function(a,b){o[b]===a&&delete o[b]});j=a.param(o);f&&a.route.attr("route",e.route);return i+(j?"&"+j:"")}return a.isEmptyObject(b)?"":"&"+a.param(b)},deparam:function(b){var f={length:-1};m(a.route.routes,function(a){a.test.test(b)&&a.length>f.length&&(f=a)});if(-1<f.length){var e=b.match(f.test),g=e.shift(),l=(g=b.substr(g.length-("&"===e[e.length-1]?1:0)))&&j.test(g)?a.deparam(g.slice(1)):{},l=c(!0,{},f.defaults,l);m(e,function(a,
b){a&&"&"!==a&&(l[f.names[b]]=decodeURIComponent(a))});l.route=f.route;return l}"&"!==b.charAt(0)&&(b="&"+b);return j.test(b)?a.deparam(b.slice(1)):{}},data:new a.Observe({}),routes:{},ready:function(b){!1===b&&(i=b);(!0===b||!0===i)&&e();return a.route},url:function(b,f){f&&(b=c({},g,b));return"#!"+a.route.param(b)},link:function(b,f,e,g){return"<a "+k(c({href:a.route.url(f,g)},e))+">"+b+"</a>"},current:function(b){return o.hash=="#!"+a.route.param(b)}});m("bind unbind delegate undelegate attr removeAttr".split(" "),
function(b){a.route[b]=function(){return a.route.data[b].apply(a.route.data,arguments)}});var b,g,e=function(){var b=o.href.split(/#!?/)[1]||"";g=a.route.deparam(b);(!l||b!==f)&&a.route.attr(g,!0)},f,l;a.bind.call(window,"hashchange",e);a.route.bind("change",function(){l=1;clearTimeout(b);b=setTimeout(function(){l=0;var b=a.route.data.serialize();o.hash="#!"+(f=a.route.param(b,!0))},1)});a.bind.call(document,"ready",a.route.ready);return a.route}(module["can/util/jquery/jquery.js"],module["can/observe/observe.js"],
...
!0:f:c.setAttribute(e,f)},f={},l={},d="ejs_"+Math.random(),n=0,s=function(a){return a[d]?a[d]:a[d]=(a.nodeName?"element_":"obj_")+ ++n},v=function(b){var c=s(b);l[c]=b;a.each(b,function(a){C(a,c)})},C=function(a,b){var c=f[s(a)];c||(c=f[s(a)]=[]);c.push(b)},A=function(b){var c=s(b);a.each(b,function(a){D(a,c)});delete l[c]},D=function(b,c){var e=f[s(b)];if(e){var d=a.inArray(c,e);0<=d&&e.splice(d,1);e.length||delete f[s(b)]}},E=function(b,c){b=a.makeArray(b);a.each(b,function(e){a.each(a.makeArray(f[s(e)]),
function(f){var d=l[f],g=a.inArray(e,d),h=a.inArray(b[b.length-1],d);if(0<=g&&0<=h){for(var i=g;i<=h;i++)D(d[i],f);d.splice.apply(d,[g,h-g+1].concat(c));a.each(c,function(a){C(a,f)})}else A(d)})})},G=function(b){return"string"==typeof b||"number"==typeof b?a.esc(b):B(b)},B=function(a){if("string"==typeof a)return a;if(!a&&0!=a)return"";var b=a.hookup&&function(b,c){a.hookup.call(a,b,c)}||"function"==typeof a&&a;return b?(x.push(b),""):""+a},q=function(a){if(this.constructor!=q){var b=new q(a);return function(a,
c){return b.render(a,c)}}"function"==typeof a?this.template={fn:a}:(j(this,a),this.template=I(this.text,this.name))};a.EJS=q;q.prototype.render=function(a,b){a=a||{};return this.template.fn.call(a,a,new q.Helpers(a,b||{}))};j(q,{txt:function(f,d,h,i,k){var j=a.compute.binder(k,i,function(a,b){y(a,b)});if(!j.isListening)return(f||0!==h?G:B)(j.value);var l,n,p=function(){j.teardown();n&&A(n)},q=function(b){a.bind.call(b,"destroyed",p);l=b},s=function(b){b||(p(),a.unbind.call(l,"destroyed",p))},i=m[d]||
"span",y,t=c[d];if(0==h&&!t)return"<"+i+a.view.hook(f?function(a,b){y=function(a){e.nodeValue=""+a;s(e.parentNode)};var c=b&&11===a.parentNode.nodeType?b:a.parentNode,e=document.createTextNode(j.value);c.insertBefore(e,a);c.removeChild(a);q(c)}:function(b,c){y=function(a){e[0].parentNode&&f(a);s(e[0].parentNode)};var c=c&&11===b.parentNode.nodeType?c:b.parentNode,e,f=function(f){var f=a.view.frag(f,c),d=a.makeArray(f.childNodes),g=e?e[e.length-1]:b;g.nextSibling?g.parentNode.insertBefore(f,g.nextSibling):
g.parentNode.appendChild(f);e?(a.remove(a.$(e)),E(e,d)):(a.remove(a.$(b)),n=e=d,v(e))};f(j.value,[b]);q(c)})+"></"+i+">";if(1===h){var u=j.value.replace(/['"]/g,"").split("=")[0];x.push(function(b){y=function(c){var c=(c||"").replace(/['"]/g,"").split("="),f=c[0];if(f!=u&&u){var d=u;-1<a.inArray(d,g)?b[d]=!1:b.removeAttribute(d)}f&&(e(b,f,c[1]),u=f)};q(b)});return j.value}var r=0==h?t:h;(0===h?F:x).push(function(c){y=function(){e(c,r,h.render(),t)};var f=a.$(c),d;(d=a.data(f,"hooks"))||a.data(f,"hooks",
d={});var g=b[r]?c[b[r]]:c.getAttribute(r),f=g.split("__!!__"),h;d[r]?d[r].bindings.push(j):d[r]={render:function(){var a=0;return g.replace(o,function(){return B(h.bindings[a++].value)})},bindings:[j],batchNum:void 0};h=d[r];f.splice(1,0,j.value);e(c,r,f.join(""),t);q(c)});return"__!!__"},pending:function(){var b=x.slice(0);F=b;x=[];return a.view.hook(function(c){a.each(b,function(a){a(c)})})},register:v,unregister:A,replace:E,nodeMap:f,nodeListMap:l});var H=RegExp("(<%%|%%>|<%==|<%=|<%#|<%|%>|<|>|\"|')",
"g"),w=null,u=null,z=null,x=[],F=[],I=function(a,b){var e=[],f=0,a=a.replace(i,"\n");a.replace(H,function(b,c,d){d>f&&e.push(a.substring(f,d));e.push(c);f=d+c.length});f<a.length&&e.push(a.substr(f));var d="",g=["var ___v1ew = [];"],j=function(a,b){g.push("___v1ew.push(",'"',a.split("\\").join("\\\\").split("\n").join("\\n").split('"').join('\\"').split("\t").join("\\t"),'"'+(b||"")+");")},m=[],l,n=null,o=!1,q="",t=[],s=0,r;for(w=u=z=null;void 0!==(r=e[s++]);){if(null===n)switch(r){case "<%":case "<%=":case "<%==":o=
1;case "<%#":n=r;d.length&&j(d);d="";break;case "<%%":d+="<%";break;case "<":0!==e[s].indexOf("!--")&&(w=1,o=0);d+=r;break;case ">":w=0;o||c[t[t.length-1]]?(j(d,',can.EJS.pending(),">"'),d=""):d+=r;"/"==l.substr(-1)&&(t.pop(),q=t[t.length-1]);break;case "'":case '"':w&&(u&&u===r?u=null:null===u&&(u=r,z=l));default:"<"===l&&(q=r.split(" ")[0],0===q.indexOf("/")&&t.pop()===q.substr(1)?q=t[t.length-1]||q.substr(1):t.push(q)),d+=r}else switch(r){case "%>":switch(n){case "<%":l=--d.split("{").length- --d.split("}").length;
1==l?(g.push("___v1ew.push(","can.EJS.txt(0,'"+q+"',"+(u?"'"+z.match(h)[1]+"'":w?1:0)+",this,function(){","var ___v1ew = [];",d),m.push({before:"",after:"return ___v1ew.join('')}));\n"})):(f=m.length&&-1==l?m.pop():{after:";"},f.before&&g.push(f.before),g.push(d,";",f.after));break;case "<%=":case "<%==":(l=--d.split("{").length- --d.split("}").length)&&m.push({before:"return ___v1ew.join('')",after:"}));"}),k.test(d)&&(d=d.match(k),d="function(__){var "+d[1]+"=can.$(__);"+d[2]+"}"),g.push("___v1ew.push(",
"can.EJS.txt("+("<%="===n?1:0)+",'"+q+"',"+(u?"'"+z.match(h)[1]+"'":w?1:0)+",this,function(){ return ",d,l?"var ___v1ew = [];":"}));")}n=null;d="";break;case "<%%":d+="<%";break;default:d+=r}l=r}d.length&&j(d);g.push(";");j={out:"with(_VIEW) { with (_CONTEXT) {"+g.join("")+" return ___v1ew.join('')}}"};p.call(j,"this.fn = (function(_CONTEXT,_VIEW){"+j.out+"});\r\n//@ sourceURL="+b+".js");return j};q.Helpers=function(a,b){this._data=a;this._extras=b;j(this,b)};q.Helpers.prototype={list:function(b,
