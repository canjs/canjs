...
module["can/util/string/string.js"]=function(a){var p=/\=\=/,k=/([A-Z]+)([A-Z][a-z])/g,j=/([a-z\d])([A-Z])/g,g=/([a-z\d])([A-Z])/g,i=/\{([^\}]+)\}/g,l=/"/g,o=/'/g;a.extend(a,{esc:function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(l,"&#34;").replace(o,"&#39;")},getObject:function(c,b,f){var c=c?c.split("."):[],e=c.length,d,m=0,h,n,b=a.isArray(b)?b:[b||window];if(!e)return b[0];for(;d=b[m++];){for(n=0;n<e-1&&/^f|^o/.test(typeof d);n++)d=c[n]in d?d[c[n]]:
f&&(d[c[n]]={});if(/^f|^o/.test(typeof d)&&(h=c[n]in d?d[c[n]]:f&&(d[c[n]]={}),void 0!==h))return!1===f&&delete d[c[n]],h}},capitalize:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},underscore:function(a){return a.replace(p,"/").replace(k,"$1_$2").replace(j,"$1_$2").replace(g,"_").toLowerCase()},sub:function(c,b,f){var e=[];e.push(c.replace(i,function(c,m){var h=a.getObject(m,b,void 0===f?f:!f);return/^f|^o/.test(typeof h)?(e.push(h),""):""+h}));return 1>=e.length?e[0]:e},replacer:i,undHash:/_|-/});
...
module["can/observe/observe.js"]=function(a,p){var k=function(a){return a&&"object"===typeof a&&!(a instanceof Date)},j=function(b,c){return a.each(b,function(a){a&&a.unbind&&a.unbind("change"+c)})},g=function(b,c,h){b instanceof n?j([b],h._cid):b=a.isArray(b)?new n.List(b):new n(b);b.bind("change"+h._cid,function(d,f){var e=a.makeArray(arguments),d=e.shift();e[0]="*"===c?h.indexOf(b)+"."+e[0]:c+"."+e[0];d.triggeredNS=d.triggeredNS||{};d.triggeredNS[h._cid]||(d.triggeredNS[h._cid]=!0,a.trigger(h,
d,e),a.trigger(h,e[0],e))});return b},i=0,l=void 0,o=function(){if(!l)return l=[],!0},c=function(c,h,d){if(!c._init)if(l)l.push([c,{type:h,batchNum:b},d]);else return a.trigger(c,h,d)},b=1,f=function(){var c=l.slice(0);l=void 0;b++;a.each(c,function(b){a.trigger.apply(a,b)})},e=function(b,c,h){b.each(function(b,d){h[d]=k(b)&&a.isFunction(b[c])?b[c]():b});return h},d=function(b){return function(){return a[b].apply(this,arguments)}},m=d("addEvent"),d=d("removeEvent"),h=function(b){return a.isArray(b)?
b:(""+b).split(".")},n=a.Observe=p({setup:function(){p.setup.apply(this,arguments)},bind:m,unbind:d,id:"id"},{setup:function(a){this._data={};this._cid=".observe"+ ++i;this._init=1;this.attr(a);delete this._init},attr:function(a,b){if(~"ns".indexOf((typeof a).charAt(0))){if(void 0===b)return n.__reading&&n.__reading(this,a),this._get(a);this._set(a,b);return this}return this._attrs(a,b)},each:function(){return a.each.apply(void 0,[this.__get()].concat(a.makeArray(arguments)))},removeAttr:function(a){var a=
...
return e},_attrs:function(b,h){if(void 0===b)return e(this,"attr",[]);var b=a.makeArray(b),c=Math.min(b.length,this.length),d=o(),n;for(n=0;n<c;n++){var m=this[n],g=b[n];k(m)&&k(g)?m.attr(g,h):m!=g&&this._set(n,g)}b.length>this.length?this.push.apply(this,b.slice(this.length)):b.length<this.length&&h&&this.splice(b.length);d&&f()}});a.each({push:"length",unshift:0},function(b,h){t.prototype[h]=function(){for(var d=arguments[0]&&a.isArray(arguments[0])?arguments[0]:a.makeArray(arguments),e=b?this.length:
0,n=0;n<d.length;n++){var f=d[n];k(f)&&(d[n]=g(f,"*",this))}n=[][h].apply(this,d);(!this.comparator||!d.length)&&c(this,"change",[""+e,"add",d,void 0]);return n}});a.each({pop:"length",shift:0},function(b,h){t.prototype[h]=function(){var d=arguments[0]&&a.isArray(arguments[0])?arguments[0]:a.makeArray(arguments),e=b&&this.length?this.length-1:0,d=[][h].apply(this,d);c(this,"change",[""+e,"remove",void 0,[d]]);d&&d.unbind&&d.unbind("change"+this._cid);return d}});a.extend(t.prototype,{indexOf:[].indexOf||
...
arguments).then(f,f)})}});f=a.proxy(this._clean,b);a.each({findAll:"models",findOne:"model"},function(e,d){var m=b[d];a.Construct._overwrite(b,c,d,function(a,d,c){this._super;b._reqs++;return p(m.call(this,a,d,c),this,e).then(d,c).then(f,f)})});"can.Model"==b.fullName&&(b.fullName="Model"+ ++k);this.store={};this._reqs=0;this._url=this._shortName+"/{"+this.id+"}"}},_ajax:l,_clean:function(){this._reqs--;if(!this._reqs)for(var a in this.store)this.store[a]._bindings||delete this.store[a]},models:function(c){if(c){if(c instanceof
this.List)return c;var b=this,f=new (b.List||o),e=a.isArray(c),d=c instanceof o,d=e?c:d?c.serialize():c.data;a.each(d,function(a){f.push(b.model(a))});e||a.each(c,function(a,b){"data"!==b&&(f[b]=a)});return f}},model:function(a){if(a){a instanceof this&&(a=a.serialize());var b=this.store[a[this.id]]?this.store[a[this.id]].attr(a):new this(a);this._reqs&&(this.store[a[this.id]]=b);return b}}},{isNew:function(){var a=this[this.constructor.id];return!(a||0===a)},save:function(a,b){return g(this,this.isNew()?
...
c,b);c===this.constructor.id&&this._bindings&&(this.constructor.store[this[this.constructor.id]]=this)}});a.each({makeFindAll:"models",makeFindOne:"model"},function(c,b){a.Model[b]=function(a){return function(b,d,m){return p(a.call(this,b),this,c).then(d,m)}}});a.each(["created","updated","destroyed"],function(c){a.Model.prototype[c]=function(b){var f=this.constructor;b&&"object"==typeof b&&this.attr(b.attr?b.attr():b);a.trigger(this,c);a.trigger(this,"change",c);a.trigger(f,c,this)}});var o=a.Model.List=
a.Observe.List({setup:function(){a.Observe.List.prototype.setup.apply(this,arguments);var c=this;this.bind("change",function(a,f){/\w+\.destroyed/.test(f)&&c.splice(c.indexOf(a.target),1)})}});return a.Model}(module["can/util/jquery/jquery.js"],module["can/observe/observe.js"]);
module["can/util/string/deparam/deparam.js"]=function(a){var p=/^\d+$/,k=/([^\[\]]+)|(\[\])/g,j=/([^?#]*)(#.*)?$/,g=function(a){return decodeURIComponent(a.replace(/\+/g," "))};a.extend(a,{deparam:function(i){var l={},o;i&&j.test(i)&&(i=i.split("&"),a.each(i,function(a){var a=a.split("="),b=g(a.shift()),f=g(a.join("="));current=l;for(var a=b.match(k),b=0,e=a.length-1;b<e;b++)current[a[b]]||(current[a[b]]=p.test(a[b+1])||"[]"==a[b+1]?[]:{}),current=current[a[b]];o=a.pop();"[]"==o?current.push(f):current[o]=
f}));return l}});return a}(module["can/util/jquery/jquery.js"],module["can/util/string/string.js"]);
module["can/route/route.js"]=function(a){var p=/\:([\w\.]+)/g,k=/^(?:&[^=]+=[^&]*)+/,j=function(b){var d=[];a.each(b,function(b,h){d.push(("className"===h?"class":h)+'="'+("href"===h?b:a.esc(b))+'"')});return d.join(" ")},g=function(a,b){var d=0,c=0,e={},f;for(f in a.defaults)a.defaults[f]===b[f]&&(e[f]=1,d++);for(;c<a.names.length;c++){if(!b.hasOwnProperty(a.names[c]))return-1;e[a.names[c]]||d++}return d},i=!0,l=window.location,o=a.each,c=a.extend;a.route=function(b,d){var d=d||{},c=[],e=b.replace(p,
function(a,e,f){c.push(e);return"([^\\"+(b.substr(f+a.length,1)||"&")+"]"+(d[e]?"*":"+")+")"});a.route.routes[b]={test:RegExp("^"+e+"($|&)"),route:b,names:c,defaults:d,length:b.split("/").length};return a.route};c(a.route,{param:function(b,d){var e,f=0,m,i=b.route,j=0;delete b.route;o(b,function(){j++});o(a.route.routes,function(a){m=g(a,b);m>f&&(e=a,f=m);if(m>=j)return!1});a.route.routes[i]&&g(a.route.routes[i],b)===f&&(e=a.route.routes[i]);if(e){var l=c({},b),i=e.route.replace(p,function(a,d){delete l[d];
return b[d]===e.defaults[d]?"":encodeURIComponent(b[d])}),k;o(e.defaults,function(a,b){l[b]===a&&delete l[b]});k=a.param(l);d&&a.route.attr("route",e.route);return i+(k?"&"+k:"")}return a.isEmptyObject(b)?"":"&"+a.param(b)},deparam:function(b){var d={length:-1};o(a.route.routes,function(a){a.test.test(b)&&a.length>d.length&&(d=a)});if(-1<d.length){var e=b.match(d.test),f=e.shift(),m=(f=b.substr(f.length-("&"===e[e.length-1]?1:0)))&&k.test(f)?a.deparam(f.slice(1)):{},m=c(!0,{},d.defaults,m);o(e,function(a,
...
module["can/control/route/route.js"]=function(a){a.Control.processors.route=function(p,k,j,g,i){a.route(j||"");var l,o=function(c){if(a.route.attr("route")===(j||"")&&(void 0===c.batchNum||c.batchNum!==l))if(l=c.batchNum,c=a.route.attr(),delete c.route,a.isFunction(i[g]))i[g](c);else i[i[g]](c)};a.route.bind("change",o);return function(){a.route.unbind("change",o)}}}(module["can/util/jquery/jquery.js"],module["can/route/route.js"],module["can/control/control.js"]);
...
registerScript:function(){},preload:function(){},render:function(b,f,e,d){p(e)&&(d=e,e=void 0);var i=o(f);if(i.length){var h=new a.Deferred;i.push(l(b,!0));a.when.apply(a,i).then(function(b){var g=k(arguments),i=g.pop();if(a.isDeferred(f))f=c(b);else for(var j in f)a.isDeferred(f[j])&&(f[j]=c(g.shift()));g=i(f,e);h.resolve(g);d&&d(g)});return h}var j,i=p(d),h=l(b,i);if(i)j=h,h.then(function(a){d(a(f,e))});else{if(h.isResolved()&&h.__view_id)return g.cachedRenderers[h.__view_id](f,e);h.then(function(a){j=
a(f,e)})}return j}});var i=function(a,c){if(!a.length)throw"can.view: No template or empty template:"+c;},l=function(b,c){var e=b.match(/\.[\w\d]+$/),d,j,h,l=function(b,c){var e=d.renderer(h,b),c=c||new a.Deferred;g.cache&&(g.cached[h]=c,c.__view_id=h,g.cachedRenderers[h]=e);c.resolve(e);return c};b.match(/^#/)&&(b=b.substr(1));if(j=document.getElementById(b))e="."+j.type.match(/\/(x\-)?(.+)/)[2];!e&&!g.cached[b]&&(b+=e=g.ext);a.isArray(e)&&(e=e[0]);h=a.view.toId(b);if(b.match(/^\/\//))var k=b.substr(2),
b=!window.steal?"/"+k:steal.config().root.mapJoin(k);d=g.types[e];if(g.cached[h])return g.cached[h];if(j)return l(j.innerHTML);var o=new a.Deferred;a.ajax({async:c,url:b,dataType:"text",error:function(a){i("",b);o.reject(a)},success:function(a){i(a,b);l(a,o)}});return o},o=function(b){var c=[];if(a.isDeferred(b))return[b];for(var e in b)a.isDeferred(b[e])&&c.push(b[e]);return c},c=function(b){return a.isArray(b)&&"success"===b[1]?b[0]:b};window.steal&&steal.type("view js",function(b,c){var e=a.view.types["."+
...
c=c.value;k=!k;a.each(d,function(a){l[a.obj._cid+"|"+a.attr]?l[a.obj._cid+"|"+a.attr].matched=k:(l[a.obj._cid+"|"+a.attr]={matched:k,observe:a},a.obj.bind(a.attr,b))});for(var f in l)d=l[f],d.matched!==k&&(d.observe.obj.unbind(d.observe.attr,b),delete l[f]);return c};c.value=f();c.isListening=!a.isEmptyObject(l);return c};a.compute=function(j,g){if(j.isComputed)return j;var i,l=0,o,c=!0;"function"===typeof j?o=function(a){return void 0===a?i?i.value:j.call(g||this):j.apply(g||this,arguments)}:(o=
function(b){if(void 0===b)return j;var c=j;j=b;c!==b&&a.trigger(o,"change",[b,c]);return b},c=!1);o.isComputed=!0;o.bind=function(b,f){a.addEvent.apply(o,arguments);l===0&&c&&(i=k(j,g||this,function(b,c){a.trigger(o,"change",[b,c])}));l++};o.unbind=function(b,f){a.removeEvent.apply(o,arguments);l--;l===0&&c&&i.teardown()};return o};a.compute.binder=k;return a.compute}(module["can/util/jquery/jquery.js"]);
module["can/view/ejs/ejs.js"]=function(a){var p=function(a){eval(a)},k=a.extend,j=/\s*\(([\$\w]+)\)\s*->([^\n]*)/,g=/([^\s]+)=$/,i=/(\r|\n)+/g,l=/__!!__/g,o={"":"span",table:"tr",tr:"td",ol:"li",ul:"li",tbody:"tr",thead:"tr",tfoot:"tr",select:"option",optgroup:"option"},c={"class":"className"},b=a.each(["checked","disabled","readonly","required"],function(a){c[a]=a}),f=function(d,e,f){c[e]?d[c[e]]=-1<a.inArray(e,b)?!0:f:d.setAttribute(e,f)},e=function(b){return"string"==typeof b||"number"==typeof b?
...
h,i,j,k){var m=a.compute.binder(k,j,function(a,b){w(a,b)});if(!m.isListening)return(g||0!==i?e:d)(m.value);var n,p=function(b){a.bind.call(b,"destroyed",m.teardown);n=b},x=function(b){b||(m.teardown(),a.unbind.call(n,"destroyed",m.teardown))},h=o[h]||"span",w;if(0==i)return"<"+h+a.view.hook(g?function(a,b){w=function(a){e.nodeValue=""+a;x(e.parentNode)};var c=b&&11===a.parentNode.nodeType?b:a.parentNode,e=document.createTextNode(m.value);c.insertBefore(e,a);c.removeChild(a);p(c)}:function(b,c){w=
function(a){d[0].parentNode&&(d=e(a,d));x(d[0].parentNode)};var c=c&&11===b.parentNode.nodeType?c:b.parentNode,e=function(b,e){var d=a.view.frag(b,c),f=a.map(d.childNodes,function(a){return a}),g=e[e.length-1];g.nextSibling?g.parentNode.insertBefore(d,g.nextSibling):g.parentNode.appendChild(d);a.remove(a.$(e));return f},d=e(m.value,[b]);p(c)})+"></"+h+">";if(1===i){var q=m.value.replace(/['"]/g,"").split("=")[0];s.push(function(c){w=function(e){var e=(e||"").replace(/['"]/g,"").split("="),d=e[0];
if(d!=q&&q){var g=q;-1<a.inArray(g,b)?c[g]=!1:c.removeAttribute(g)}d&&(f(c,d,e[1]),q=d)};p(c)});return m.value}s.push(function(b){w=function(){f(b,i,j.render())};var e=a.$(b),g;(g=a.data(e,"hooks"))||a.data(e,"hooks",g={});var h=c[i]?b[c[i]]:b.getAttribute(i),e=h.split("__!!__"),j;g[i]?g[i].bindings.push(m):g[i]={render:function(){var a=0;return h.replace(l,function(){return d(j.bindings[a++].value)})},bindings:[m],batchNum:void 0};j=g[i];e.splice(1,0,m.value);f(b,i,e.join(""));p(b)});return"__!!__"},
