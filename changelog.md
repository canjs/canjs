...
- [Stache #each teardown throws an error on observable functions](https://github.com/bitovi/canjs/issues/2001)
- [New bindings do not always update the scope](https://github.com/bitovi/canjs/issues/1996)
- [Binding docs](https://github.com/bitovi/canjs/pull/1993)
- [adding routeUrl and routeCurrent](https://github.com/bitovi/canjs/pull/1992)
- [merges binding logic](https://github.com/bitovi/canjs/pull/1986)
- [Returning 0 from a helper displays nothing](https://github.com/bitovi/canjs/issues/1985)
- [fixes a bug with deep methods like foo.bar() in bindings](https://github.com/bitovi/canjs/pull/1982)
- [#each doesn&#39;t work with else](https://github.com/bitovi/canjs/issues/1979)
- [Do not use pushstate routing on file:// protocol URLs](https://github.com/bitovi/canjs/pull/1965)
- [Add support for drag-and-drop events in can.Component](https://github.com/bitovi/canjs/issues/1955)
- [Operators and call expressions](https://github.com/bitovi/canjs/pull/1946)
- [Can-event gets broken in production if method does not exist.](https://github.com/bitovi/canjs/issues/1942)
- [can.isArray behaves differently using can.util.jquery vs can.util.domless](https://github.com/bitovi/canjs/issues/1938)
- [Rename ~ helper](https://github.com/bitovi/canjs/issues/1932)
- [Optimize sort plugin inserts (#1883)](https://github.com/bitovi/canjs/pull/1927)
- [Missing Doc can.Deferred.prototype](https://github.com/bitovi/canjs/issues/1890)
- [sub-expression methods that return data are broken](https://github.com/bitovi/canjs/issues/1887)
- [slice and join are not observable](https://github.com/bitovi/canjs/issues/1884)
- [Add ability to override can.route&#39;s batch with other batching implementations](https://github.com/bitovi/canjs/pull/1882)
- [can/view/autorender doesn&#39;t import $.fn.viewModel](https://github.com/bitovi/canjs/issues/1880)
- [Conditional &quot;readonly&quot; attribute does not work](https://github.com/bitovi/canjs/issues/1874)
- [&quot;for&quot; attribute is &quot;htmlFor&quot; property](https://github.com/bitovi/canjs/issues/1872)
- [Fixes #1862. Objects with addEventListener now bindable](https://github.com/bitovi/canjs/pull/1868)
- [Add textarea example to can-value docs](https://github.com/bitovi/canjs/issues/1867)
- [switch/case might not work when nested](https://github.com/bitovi/canjs/issues/1857)
- [Pushstate should prevent default for javascript:// links](https://github.com/bitovi/canjs/issues/1848)
- [stache expressions don&#39;t work right with parent context values](https://github.com/bitovi/canjs/issues/1842)
- [Makes sure unbind is not call unnecessarily on can.Lists passed to can.view.live.list](https://github.com/bitovi/canjs/pull/1836)
- [can.view.live.list unbinds from the list unnecessarily](https://github.com/bitovi/canjs/issues/1835)
- [Stache subexpressions ](https://github.com/bitovi/canjs/pull/1832)
- [Steal Stache plugin should provide module id and path to templates](https://github.com/bitovi/canjs/issues/1817)
- [Create ~ helper for joining to the baseURL](https://github.com/bitovi/canjs/issues/1816)
- [Pass options to helpers](https://github.com/bitovi/canjs/pull/1815)
- [Pass parent scope helpers to helper&#39;s options](https://github.com/bitovi/canjs/pull/1807)
- [Merges master into minor](https://github.com/bitovi/canjs/pull/1805)
- [Parent helpers inside helper](https://github.com/bitovi/canjs/issues/1783)
- [Live-list diffing](https://github.com/bitovi/canjs/pull/1782)
- [Expand the Observables guide page](https://github.com/bitovi/canjs/issues/1753)
- [Add screenshots to the 2.3 guides](https://github.com/bitovi/canjs/issues/1749)
- [can.List filter should return lists of the same type](https://github.com/bitovi/canjs/issues/1744)
- [Work-in-progress version of the new guides](https://github.com/bitovi/canjs/pull/1741)
- [Observable promises is not documented](https://github.com/bitovi/canjs/issues/1729)
- [Revert &quot;Use [.] to represent a template&#39;s viewModel&quot;](https://github.com/bitovi/canjs/pull/1726)
- [Sort plugin excludes batchNum; Maybe fires unnecessary events](https://github.com/bitovi/canjs/issues/1707)
- [Sort plugin evaluates insert index for batched events](https://github.com/bitovi/canjs/issues/1706)
- [Sort plugin swaps equal value items](https://github.com/bitovi/canjs/issues/1705)
- [Deprecate can.Map.prototype.COMPUTE-ATTR](https://github.com/bitovi/canjs/issues/1703)
- [autorender system plugin should normalize the main](https://github.com/bitovi/canjs/issues/1683)
- [Import view model](https://github.com/bitovi/canjs/pull/1649)
- [Stache and Mustache registerSimpleHelper](https://github.com/bitovi/canjs/pull/1646)
- [can-href](https://github.com/bitovi/canjs/pull/1642)
- [can.view.href](https://github.com/bitovi/canjs/pull/1641)
- [Document setting context of Stache data helper](https://github.com/bitovi/canjs/pull/1640)
- [Changing context in a Stache template breaks the data helper](https://github.com/bitovi/canjs/issues/1619)
- [{{#helper}} documentation examples are missing the &quot;#&quot;](https://github.com/bitovi/canjs/issues/1535)
- [getHelper for can.stache and can.mustache should not require options](https://github.com/bitovi/canjs/issues/1497)
- [Better docs on iterating performance of #section and #each.](https://github.com/bitovi/canjs/issues/1488)
- [methods get arguments passed to them](https://github.com/bitovi/canjs/issues/1473)
- [Dev Mode Warning on &quot;watch&quot; properties](https://github.com/bitovi/canjs/issues/1437)
- [Proposal: `can-scope` for exporting scope into the surrounding context.](https://github.com/bitovi/canjs/issues/1362)
- [can.view.attr won&#39;t trigger in can.mustache if no value is provided](https://github.com/bitovi/canjs/issues/1353)
- [Documentation raises error 404 in can.route.map demo](https://github.com/bitovi/canjs/issues/1294)
- [can.Compute as a prototype based can.compute](https://github.com/bitovi/canjs/issues/1255)
- [Document how mustache tags handle lists](https://github.com/bitovi/canjs/issues/1254)
- [Native CanJS Event Streams](https://github.com/bitovi/canjs/issues/1218)
- [can.mustache #if renders __!!__ when value changes](https://github.com/bitovi/canjs/issues/1151)
- [can.Model.models documentation unclear](https://github.com/bitovi/canjs/issues/1129)
- [Mustache helper has no rendered output, if the output is 0.](https://github.com/bitovi/canjs/issues/1109)
- [can-href link helper](https://github.com/bitovi/canjs/issues/1103)
- [registerSimpleHelper](https://github.com/bitovi/canjs/issues/1102)
- [Putting a can.compute on a Component scope throws](https://github.com/bitovi/canjs/issues/1086)
- [define::set doc issues](https://github.com/bitovi/canjs/issues/1047)
- [Mustache deferreds](https://github.com/bitovi/canjs/pull/1031)
- [951 can model promises](https://github.com/bitovi/canjs/pull/956)
- [{{#with}} Mustache helper pushes can.compute into Scope, breaks can.compute.read](https://github.com/bitovi/canjs/issues/871)
- [can-value=&quot;.&quot; not working properly](https://github.com/bitovi/canjs/issues/800)
- [Dev Warning : mutable values in can.Control.defaults](https://github.com/bitovi/canjs/issues/704)
- [can.route.default](https://github.com/bitovi/canjs/issues/672)
- [Live binding of not-yet-defined attr in a Component&#39;s template fails](https://github.com/bitovi/canjs/issues/579)
- [can.route triggers event two times for setting nested object.](https://github.com/bitovi/canjs/issues/269)
- [Make promises observable](https://github.com/bitovi/canjs/issues/179)
