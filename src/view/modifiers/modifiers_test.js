steal("can/map", "can/view/ejs", "can/view/modifiers", "can/test", "steal-qunit", function () {
	...
	test('modifier with a deferred', function () {
		...
		$('#qunit-fixture')
			.html(can.test.path('src/view/test/deferred.ejs'), foo);
	
		var templateLoaded = new can.Deferred(),
			id = can.view.toId( can.test.path('src/view/test/deferred.ejs') );
	...
	test('val set with a template within a hookup within another template', function () {
		var frag = can.view(can.test.path('src/view/test/hookupvalcall.ejs'), {});
	...
	test('jQuery.fn.hookup', function () {
		can.$('#qunit-fixture')
			.html('');
		var els = $(can.view.render(can.test.path('src/view/test/hookup.ejs'), {}))
			.hookup();
		can.$('#qunit-fixture')
			.html(els);
