...
export { default as kefir, default as Kefir } from "./es/can-kefir";
...
export { default as observableMixin } from "./es/can-observable-mixin";
export { default as defineMixin } from "./es/can-observable-mixin"; // legacy
