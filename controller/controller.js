...
/* @Static*/
{
	...
	init : function(){
		...
		this.underscoreFullName = this.fullName.replace(/\./g,'_').replace(/controllers?/i,"").toLowerCase();
		this.underscoreControllerName = this.shortName.replace(/\./g,'_').replace(/controllers?/i,"");
