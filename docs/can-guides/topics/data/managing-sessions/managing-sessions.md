...
- `ObjectType` configures what [can-observable-object ObservableObject] will represent the session and will have the `current` & `currentPromise` properties added to it.
...
@sourceref ./cookie-session-vm.html
@highlight 16-31, 47, 55, 59, 94, 101-104, 106-108, 127-134, only  
@codepen
