	...
	$.ApplicationError = {
		...
		create_dom: function(error){
			...
			var a = $('<a />')
				...
				.click($.ApplicationError.send)
				.html('Close')
			var span = $('<span />')
				.attr('id', '_error_seconds')
				.css({
					'float': 'right',
					'font-size': '10pt'
				})
			...
			var textarea = $('<textarea />')
				...
				.focus(function(){
					...
					if(area.val() == $.ApplicationError.textarea_text) area.val('');
