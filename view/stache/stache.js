...
var HTMLSectionBuilder = require('./html_section');
var TextSectionBuilder = require('./text_section');
var mustacheCore = require('can/view/stache/mustache_core');
var mustacheHelpers = require('can/view/stache/mustache_helpers');
var getIntermediateAndImports = require('./intermediate_and_imports');
var viewCallbacks = require('can/view/callbacks/callbacks');
require('can/view/bindings/bindings');
require('can/view/target/target');
require('can/view/elements');
