...
If the value is a URL and you are using [RequireJS](http://requirejs.org/), the URL will be relative to [`baseUrl`](http://requirejs.org/docs/api.html#config-baseUrl).  
