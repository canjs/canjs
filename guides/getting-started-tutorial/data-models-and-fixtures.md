@page DataModelsAndFixtures Data Models and Fixtures
@parent Tutorial 9
...
Get the code for: [chapter: data models and fixtures](https://github.com/canjs/canjs/blob/minor/guides/examples/PlaceMyOrder/ch-6_canjs-getting-started.zip?raw=true)
