steal('funcunit/qunit', './store.js', 'jquery/model', 'jquery/model/list', 'jquery/dom/fixture', function () {
	var Item;
	module('store', {
		setup: function () {}
	});
...
test("smart findAll", function(){
	...
	test('Store Update', function () {
		...
		var list1 = Item.Store.findAll({
			parentId: 1
		}),
			list2 = Item.Store.findAll({
				parentId: 2
			}),
			first;
		stop();
