...
steal("can/model", 'can/map/attributes', "can/test", "can/util/fixture", function () {
	...
	test("Nested lists", function(){
		...
		ok(!(teacher.attr('locations') instanceof Teacher.List), 'nested list is not an instance of MyMap.List');
		ok(!(teacher.attr('locations')[0] instanceof Teacher), 'nested map is not an instance of MyMap');
	});
