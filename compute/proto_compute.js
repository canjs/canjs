...
var read = require('can/compute/read');
var ObservedInfo = require('can/compute/get_value_and_bind');
require('can/util/bind/bind');
require('can/util/batch/batch');
...
module.exports = exports = can.Compute;
